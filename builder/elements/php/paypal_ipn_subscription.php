<?php
// Paypal IPN Listener for GLC Builder Paypal Notification - Subscription Version
...
if (strcmp ($res, "VERIFIED") == 0) {
	...
	if($txn_type == "subscr_payment") {
		...
		$subject = "GLC Builder Paypal Subscription Notification"; //insert here the subject of the email
