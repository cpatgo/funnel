<?php
	...
	$filename = "tmp/my_glcbuilder.zip"; //use the /tmp folder to circumvent any permission issues on the root folder
	...
	foreach( $_POST['pages'] as $page=>$content ) {
		$content = preg_replace("/GLC Builder - Landing Page with Page Builder/", $_POST['title'], $content);
