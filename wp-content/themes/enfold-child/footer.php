		...
		?>
				<div class='container_wrap footer_color' id='footer'>
					...
					<div class='container'>
						...
						//If user is logged in and the membership is Professional, Masters or Founder, remove the Upgrade button
						if(is_user_logged_in()):
							$usermembership = get_usermeta(get_current_user_id(), 'membership', true);
							if($usermembership === 'Founder' || $usermembership === 'Masters' || $usermembership === 'Professional'):
								?>
								<script type="text/javascript">
									(function($){	
										$('body').find('.membership_upgrade_button').remove();
									}(jQuery));
								</script>
								<?php
							endif;
						...
						<?php if(!is_user_logged_in()): ?>
							<div class="sub_footer">
								<hr />
								<p class="cc"><img src="/glc/images/cc_old.png" alt="logo"></p>
							</div>
						<?php endif; ?>
					</div>
			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
                        ...
                        <span class='copyright'><?php echo $copyright . ' ' . date('Y'); ?></span>
