...
if(!function_exists('avia_title'))
{
	function avia_title($args = false, $id = false)
	{
		...
		$defaults 	 = array(
			...
			'html'			=> "<div class='{class} title_container'><div class='container'><{heading} class='main-title entry-title'></{heading}>{additions}</div></div>",
...
// Creating the widget 
class glc_featured_course_category_widget extends WP_Widget {
...
public function widget( $args, $instance ) {
	...
	<p>
			<label for="<?php echo $this->get_field_id( '' ); ?>"><?php _e( 'Title:' ); ?></label> 
	</p>
...
} // Class glc_featured_course_category_widget ends here

// Register and load the widget
function wpb_load_widget() {
	register_widget( 'glc_featured_course_category_widget' );
}
