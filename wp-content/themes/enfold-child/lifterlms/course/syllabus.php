			...
			<?php else : ?>
				<?php foreach ( $lessons as $lesson_child ) : ?>
					...
					if ( ! $page_restricted['is_restricted'] || $lesson->get_is_free()) {
						...
						$title = __( 'Start this course to unlock this lesson', 'lifterlms' );
						$linkclass = 'llms-lesson-link-locked';

						if(!is_user_logged_in()) $title = __( 'Please SIGN UP NOW to take this course and gain access to many more.', 'lifterlms' );
					}
					?>
