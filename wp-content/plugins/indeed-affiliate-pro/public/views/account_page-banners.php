		...
		<?php foreach ($data['listing_items'] as $arr) : ?>
			<div class="uap-banner">
				...
				<div class="uap-banner-content">
					...
					<div class="uap-banner-description"><?php echo __('Description:', 'uap') . ' ' . $arr->description;?></div>
					...
					<div class="uap-banner-copypaste">
						...
						<textarea disabled><a href="<?php echo $arr->url;?>" target="_blank"><img src="<?php echo $arr->image;?>" /></a></textarea>			
					</div>
				</div>
			</div>
		<?php endforeach;?>	
