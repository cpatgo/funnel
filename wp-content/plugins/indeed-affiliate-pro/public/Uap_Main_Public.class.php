...
if (!class_exists('Uap_Main_Public')){ 
	class Uap_Main_Public{
		...
		public function affiliate_print_register_form($args=array()){
			/*
			 * @param array
			 * @return string
			 */
		...
		public function affiliate_print_login_form(){
			/*
			 * @param 
			 * @return string
			 */
			...
			if ($this->is_admin){
				...
				return $object->print_login_form(array(), $this->user_role, $this->affiliate_id);
			}
			return '';
		}
		...
		public function affiliate_print_logout(){
			/*
			 * @param none
			 * @return none
			 */
			...
			if ($this->user_id){ // && $this->affiliate_id
				$data['metas']['login_custom_css'] = get_option('uap_login_custom_css'); // style from login...
		...
		public function check_page(){
			...
			global $indeed_db;
			$url = UAP_PROTOCOL . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
		...
		public function all_new_users_become_affiliates($uid=0){
			 ...
			 * @return none
			 */			 
			 if (get_option('uap_all_new_users_become_affiliates') && $uid){ 	
				 global $indeed_db;
