		...
		<div class="row">
			...
			<div class="col-xs-3">
				<div class="uap-dashboard-top-box">
					...
					<div class="stats">
						<h4><?php echo round($data['stats']['unpaid_payments_value'], 2) . ' ' . $data['stats']['currency'];?></h4>
			...
			<div class="col-xs-3">
				<div class="uap-dashboard-top-box">
					...
					<div class="stats">
						<h4><?php echo round($data['stats']['paid_payments_value'], 2) . ' ' . $data['stats']['currency'];?></h4>
	...
	<form action="<?php echo $data['pay_action'];?>" method="post" id="form_payments">
					<table class="wp-list-table widefat fixed tags">
						...
						<tbody class="ui-sortable uap-alternate">
							...
							<tr>
								<td>
									<div class="uap-list-affiliates-name-label"><?php echo $array['username'];?></div>
									<?php
								...
								<td><?php echo round($array['total_paid'], 2) . ' ' . $array['paid_currency'];?></td>

								<td><?php 
									echo '<strong style="color: #9b4449;">'.round($array['total_unpaid'], 2) . ' ' . $array['unpaid_currency'].'</strong>';
