<div id="jp_container_<?php echo $this->listtoken; ?>" class="jp-video" style="width:<?php echo $this->options['maxwidth']; ?>;max-width:<?php echo $this->options['maxwidth']; ?>">
  ...
  <div class="jp-gui">
    <div class="jp-interface">
      <div class="jp-song-title">
        <div class="jp-playlist-item-song-title"><?php _e('Wait...', 'outofthebox'); ?></div>
        <div class="jp-playlist-item-song-artist"><?php _e('Busy loading playlist', 'outofthebox'); ?></div>
      </div>
  ...
  <div class="jp-no-solution">
    <strong><?php _e('Update Required', 'outofthebox'); ?></strong><br/>
