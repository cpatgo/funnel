  ...
  $(window).load(function () {
    ...
    $('.OutoftheBox.media.video').each(function () {
          ...
          $.ajax({
            ...
            success: function (result) {
              if (result !== '-1') {
                ...
                if (autoplay === '0') {
                  oftb_playlists[listtoken].pause(0.1);
                }
                if (!$(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").hasClass('hideonstart')) {
                  $(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").slideDown("slow");
                }
      ...
      $(this).hover(
              function () {
                guivisable = true;
                $(this).find('.gui-container').stop().animate({bottom: 0}, 400).delay(5000).animate({bottom: -40}, 400, function () {
                  guivisable = false;
                });
              },
              function () {
                $(this).find('.gui-container').stop().animate({bottom: -40}, 400, function () {
                  guivisable = false;
                });
              });
    });
