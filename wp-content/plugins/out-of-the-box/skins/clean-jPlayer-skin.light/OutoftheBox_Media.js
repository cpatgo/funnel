  ...
  $(window).load(function () {
    ...
    $('.OutoftheBox.media.audio').each(function () {
      ...
      oftb_playlists[listtoken] = new jPlayerPlaylist({
        ...
        volume: 1,
        ready: function () {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").show();
          var data = {
        ...
        loadstart: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").html($(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist-item.jp-playlist-current").html());
        },
        play: function (e) {
          var dataname = $(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist-item.jp-playlist-current  .jp-playlist-item-song-title").html();
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").html(dataname);
    ...
    $('.OutoftheBox.media.video').each(function () {
      ...
      oftb_playlists[listtoken] = new jPlayerPlaylist({
        ...
        pause: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").height($(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer").height());
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").fadeIn();
        },
        loadstart: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").html($(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist-item.jp-playlist-current").html());
        },
        ...
        play: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").fadeOut();
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer").one('click', function () {
    ...
    function createAudioSlider(listtoken) {
      ...
      $(".OutoftheBox[data-token='" + listtoken + "'] .currentVolume").slider({
        range: [0, 1],
        step: 0.01,
        start: 1,
        handles: 1,
        slide: function () {
          var value = $(this).val();
          $(".OutoftheBox[data-token='" + listtoken + "']  .jp-jplayer").jPlayer("option", "muted", false);
          $(".OutoftheBox[data-token='" + listtoken + "']  .jp-jplayer").jPlayer("option", "volume", value);
          $(".OutoftheBox[data-token='" + listtoken + "']  .volumeText").html('Volume: ' + (value * 100).toFixed(0) + '');
        }
      });

      $(".OutoftheBox[data-token='" + listtoken + "'] .seekBar").slider({
        range: [0, 100],
        step: 0.01,
        start: 0,
        handles: 1,
        slide: function () {
          var value = $(this).val();
          $(".OutoftheBox[data-token='" + listtoken + "']  .jp-jplayer").jPlayer("playHead", value);
        }
