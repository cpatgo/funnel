...
Example response:
{
  ...
  [captcha] => Require Captcha image? Examples: yes (1) or no (0)
	...
	[html] => <form method="post" action="http://mysite.com/em/branches/5.2.4/surround.php">
	...
	<style type='text/css'>@import url(http://mysite.com/em/branches/5.2.4/awebdesk/jscalendar/calendar-win2k-1.css);</style>
	<script type='text/javascript' src='http://mysite.com/em/branches/5.2.4/awebdesk/jscalendar/calendar.js'></script>
	<script type='text/javascript' src='http://mysite.com/em/branches/5.2.4/awebdesk/jscalendar/lang/calendar-en.js'></script>
	<script type='text/javascript' src='http://mysite.com/em/branches/5.2.4/awebdesk/jscalendar/calendar-setup.js'></script>
	<a href='#' onclick='return false;' id='datecbutton1'><img src='http://mysite.com/em/branches/5.2.4/awebdesk/media/calendar.png' border='0' /></a><script type='text/javascript'>Calendar.setup({inputField: 'datecfield1', ifFormat: '%Y-%m-%d', button: 'datecbutton1', showsTime: false, timeFormat: '24'});</script></td>
	</tr>
	...
	<td>
		<img border="1" align="middle" src="http://mysite.com/em/branches/5.2.4/awebdesk/scripts/imgrand.php" /><br />
	...
	<div style="font-size:10px; margin-top:10px; color:#999999;"><a href="http://www.awebdesk.com/email-marketing/" title="email marketing" style="color:#666666;">Email Marketing</a> by AwebDesk</div>
	</td>
	</tr>
	</table>

	</form>
	[htmllink] => http://mysite.com/em/branches/5.2.4/index.php?q=form&type=html&id=1005
	[xml] => <flashform postForm="http://mysite.com/em/branches/5.2.4/surround.php" stagecolor="0xFFFFFF">
	...
	[xmllink] => http://mysite.com/em/branches/5.2.4/index.php?q=form&type=xml&id=1005
...
$url    = 'http://glcv2.identifz.com/aem';
