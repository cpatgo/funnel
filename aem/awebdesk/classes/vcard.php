...
function vcard_encode($string) {
	return vcard_escape(quoted_printable_encode($string));
}
...
class vCard {
	...
	function setName($family="", $first="", $additional="", $prefix="", $suffix="") {
		...
		if ( isset($this->properties["FN"]) and $this->properties["FN"]=="" ) $this->setFormattedName(trim("$prefix $first $additional $family $suffix"));
	}
	...
	// $type may be DOM | INTL | POSTAL | PARCEL | HOME | WORK or any combination of these: e.g. "WORK;PARCEL;POSTAL"
		...
		if ($type!="") $key.= ";$type";
		$key.= ";ENCODING=QUOTED-PRINTABLE";
		$this->properties[$key] = /*vcard_encode($name).";".*/vcard_encode($extended).";".vcard_encode($street).";".vcard_encode($city).";".vcard_encode($region).";".vcard_encode($zip).";".vcard_encode($country);
