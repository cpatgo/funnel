...
require_once(awebdesk_classes('Zend/Gdata/App/Extension.php'));

/**
 * @see Zend_Gdata_App_Extension_Name
 */
//require_once 'Zend/Gdata/App/Extension/Name.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Name.php'));

/**
 * @see Zend_Gdata_App_Extension_Email
 */
//require_once 'Zend/Gdata/App/Extension/Email.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Email.php'));

/**
 * @see Zend_Gdata_App_Extension_Uri
 */
//require_once 'Zend/Gdata/App/Extension/Uri.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Uri.php'));
