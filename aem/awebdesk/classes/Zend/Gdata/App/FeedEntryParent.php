...
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Element.php'));

/**
 * @see Zend_Gdata_App_Extension_Author
*/
//require_once 'Zend/Gdata/App/Extension/Author.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Author.php'));

/**
 * @see Zend_Gdata_App_Extension_Category
*/
//require_once 'Zend/Gdata/App/Extension/Category.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Category.php'));

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
//require_once 'Zend/Gdata/App/Extension/Contributor.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Contributor.php'));

/**
 * @see Zend_Gdata_App_Extension_Id
 */
//require_once 'Zend/Gdata/App/Extension/Id.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Id.php'));

/**
 * @see Zend_Gdata_App_Extension_Link
 */
//require_once 'Zend/Gdata/App/Extension/Link.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Link.php'));

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
//require_once 'Zend/Gdata/App/Extension/Rights.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Rights.php'));

/**
 * @see Zend_Gdata_App_Extension_Title
 */
//require_once 'Zend/Gdata/App/Extension/Title.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Title.php'));

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
//require_once 'Zend/Gdata/App/Extension/Updated.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Updated.php'));

/**
 * Zend_Version
 */
//require_once 'Zend/Version.php';
require_once(awebdesk_classes('Zend/Version.php'));
