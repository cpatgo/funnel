...
require_once(awebdesk_classes('Zend/Gdata/App/Entry.php'));
...
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Generator.php'));

/**
 * @see Zend_Gdata_App_Extension_Icon
 */
//require_once 'Zend/Gdata/App/Extension/Icon.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Icon.php'));

/**
 * @see Zend_Gdata_App_Extension_Logo
 */
//require_once 'Zend/Gdata/App/Extension/Logo.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Logo.php'));

/**
 * @see Zend_Gdata_App_Extension_Subtitle
 */
//require_once 'Zend/Gdata/App/Extension/Subtitle.php';
require_once(awebdesk_classes('Zend/Gdata/App/Extension/Subtitle.php'));
