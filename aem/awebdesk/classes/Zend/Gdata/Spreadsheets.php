 ...
 * Zend_Gdata
 */
require_once(awebdesk_classes('Zend/Gdata.php'));

/**
 * Zend_Gdata_Spreadsheets_SpreadsheetFeed
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/SpreadsheetFeed.php'));

/**
 * Zend_Gdata_Spreadsheets_WorksheetFeed
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/WorksheetFeed.php'));

/**
 * Zend_Gdata_Spreadsheets_CellFeed
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/CellFeed.php'));

/**
 * Zend_Gdata_Spreadsheets_ListFeed
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/ListFeed.php'));

/**
 * Zend_Gdata_Spreadsheets_SpreadsheetEntry
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/SpreadsheetEntry.php'));

/**
 * Zend_Gdata_Spreadsheets_WorksheetEntry
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/WorksheetEntry.php'));

/**
 * Zend_Gdata_Spreadsheets_CellEntry
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/CellEntry.php'));

/**
 * Zend_Gdata_Spreadsheets_ListEntry
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/ListEntry.php'));

/**
 * Zend_Gdata_Spreadsheets_DocumentQuery
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/DocumentQuery.php'));

/**
 * Zend_Gdata_Spreadsheets_ListQuery
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/ListQuery.php'));

/**
 * Zend_Gdata_Spreadsheets_CellQuery
 */
require_once(awebdesk_classes('Zend/Gdata/Spreadsheets/CellQuery.php'));
...
class Zend_Gdata_Spreadsheets extends Zend_Gdata
{
    ...
    // ours - returns just the URI
    public function adesk_getListFeed($location)
    {
        if ($location instanceof Zend_Gdata_Spreadsheets_ListQuery) {
            $uri = $location->getQueryUrl();
        } else if ($location instanceof Zend_Gdata_Spreadsheets_WorksheetEntry) {
