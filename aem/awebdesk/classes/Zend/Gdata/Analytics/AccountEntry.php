...
require_once(awebdesk_classes('Zend/Gdata/Analytics/Extension/Property.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/Extension/Metric.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/Extension/Dimension.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/Extension/TableId.php'));
