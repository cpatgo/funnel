...
require_once(awebdesk_classes('Zend/Gdata/App/Feed.php'));

/**
 * Zend_Gdata_Http_Client
 */
//require_once 'Zend/Http/Client.php';
require_once(awebdesk_classes('Zend/Http/Client.php'));
...
require_once(awebdesk_classes('Zend/Gdata/App/MediaSource.php'));
...
class Zend_Gdata_App
{
    ...
    /**
     * Client object used to communicate in static assets
     *
     * @var Zend_Http_Client
     */
        ...
        $body = null, $contentType = null, $remainingRedirects = null)
    {
        ...
        require_once(awebdesk_classes('Zend/Http/Client/Exception.php'));
        ...
        if (!$response->isSuccessful()) {
            //require_once 'Zend/Gdata/App/HttpException.php';
            require_once(awebdesk_classes('Zend/Gdata/App/HttpException.php'));
    ...
    public function __call($method, $args)
    {
        if (preg_match('/^new(\w+)/', $method, $matches)) {
            ...
            //require_once 'Zend/Gdata/App/Exception.php';
            require_once(awebdesk_classes('Zend/Gdata/App/Exception.php'));
