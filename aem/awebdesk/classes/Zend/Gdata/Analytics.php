...
require_once(awebdesk_classes('Zend/Gdata/Analytics/AccountFeed.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/AccountEntry.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/DataFeed.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/DataEntry.php'));
require_once(awebdesk_classes('Zend/Gdata/Analytics/DataQuery.php'));
