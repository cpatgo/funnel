...
require_once(awebdesk_classes('Zend/Uri.php'));
...
require_once(awebdesk_classes('Zend/Http/Response.php'));

/**
 * @see Zend_Http_Response_Stream
 */
//require_once 'Zend/Http/Response/Stream.php';
require_once(awebdesk_classes('Zend/Http/Response/Stream.php'));
