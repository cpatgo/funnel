<?php
/** 
* The content of this file is (c) 2005 digital media center GmbH
* All rights reserved
*
...
* @package		JSON
* @access		public
* @copyright	(c) 2005 digital media center GmbH, all rights reserved
...
//---- logic -------------------------------------------------------------------
	/* initialize object */
	$myObj->setId('Äl' . chr(18) . "ie\nn");
	$myObj->setName('objectName');
	array_push($myObj->attribs, 'øfirst');
