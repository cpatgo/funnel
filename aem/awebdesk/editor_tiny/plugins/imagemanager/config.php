<?php
	...
	if (isset($_SESSION["_hosted_account"]))
		$mcImageManagerConfig['preview.urlprefix'] = "{proto}://images.{host}/"; // domain name
	else
	...
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "ACIsLoggedIn";
	...
	$mcImageManagerConfig['SessionAuthenticator.rootpath_key'] = "ACRootPath";
