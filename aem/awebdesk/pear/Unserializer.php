 ...
 */
require_once(awebdesk_pear('PEAR.php'));

/**
 * uses XML_Parser to unserialize document
 */
require_once(awebdesk_pear('Parser.php'));
 ...
 *
 * //  be careful to unset the var first, then never use the ampersand in front of the new operator
 * unset($unserializer);
