...
require_once awebdesk_pear('SOAP/Value.php');
require_once awebdesk_pear('SOAP/Base.php');
require_once awebdesk_pear('SOAP/Transport.php');
require_once awebdesk_pear('SOAP/WSDL.php');
require_once awebdesk_pear('SOAP/Fault.php');
require_once awebdesk_pear('SOAP/Parser.php');
