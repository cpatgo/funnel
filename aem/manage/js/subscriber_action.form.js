var subscriber_action_form_str_cant_insert = '{"You do not have permission to add Subscription Rule"|alang|js}';
var subscriber_action_form_str_cant_update = '{"You do not have permission to edit Subscription Rule"|alang|js}';
var subscriber_action_form_str_cant_update = '{"Subscription Rule not found."|alang|js}';
var subscriber_action_form_str_any         = '{"Any"|alang|js}';
var subscriber_action_form_str_needname    = '{"You must enter a name before saving."|alang|js}';
var subscriber_action_form_str_needact     = '{"You must give at least one action before saving."|alang|js}';
var subscriber_action_form_str_actions     = '{"Action(s)"|alang|js}';

var subscriber_action_form_fromcampaign    = {$fromcampaign|default:'false'};
