...
class new_funnel_form_campaign_assets extends AWEBP_Page {



	function new_funnel_form_campaign_assets() {
	...
	function process(&$smarty) {
		...
		$smarty->assign("content_template", "new_funnel_form_campaign.htm");
		...
		// $paginator = new Pagination($total, $count, 20, 0, 'desk.php?action=new_funnel_form_campaign');

		// $paginator->allowLimitChange = true;

		// $paginator->ajaxAction = 'new_funnel_form_campaign.form_select_array_paginator';
