<?php
/**
Title: Delete multiple existing mailing lists.

Description: Allows you to delete multiple mailing lists at once.
...
Parameters (* denotes requirement):
{
	...
	[*ids] => ID's (comma-separated) of the mailing lists you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: List deleted
...
$params = array(
	...
	// a comma-separated list of IDs of lists you wish to delete
	'ids'          => '1,2,3,4,5',
);
