<?php
/**
Title: View forwarded email addresses for a specific campaign.

Description: View all forwards for a specific campaign. You will be able to see the email address of each forward, much like on the Campaign Reports page.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_forward_list
...
Example response:
{
	[0] => Array
	  (
	    ...
	    [messageid] => ID of the message. Example: 1
	    [email_from] => Email of the subscriber. Example: test@gmail.com
	    [tstamp] => Date and time of the occurrence. Example: 2011-03-07 11:42:51
	    [a_times] => Number of times forwarded. Example: 1
	    [email_to] => Email of the forward recipient. Example: test2@gmail.com
	    [brief_message] => Message included with the forward. Example: Hey - check this out!
	  )
