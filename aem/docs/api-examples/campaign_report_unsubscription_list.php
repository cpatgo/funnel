<?php
/**
Title: View unsubscriptions for a specific campaign.

Description: View unsubscriptions for a specific campaign. You will be able to see the subscriber of each unsubscription, much like on the Campaign Reports page.
...
Example response:
{
	[0] => Array
	  (
	    [email] => Email address of the unsubscriber. Example: test@gmail.com
	    [subscriberid] => Subscriber ID. Example: 2
	    [udate] => Unsubscribe date: 2011-03-08 14:24:44
	    [unsubreason] => Reason for unsubscribing (if provided).
	  )
