<?php
/**
Title: Delete multiple existing subscription forms.

Description: Allows you to delete multiple subscription forms at once.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => form_delete_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of the subscription forms you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Subscription form deleted
...
$params = array(
	...
	// this is the action that deletes a message based on the ID you provide
	'api_action'   => 'form_delete_list',
	...
	// a comma-separated list of IDs of subscription forms you wish to delete
	'ids'          => '1001,1002',
);
