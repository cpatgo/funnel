<?php
/**
Title: Delete existing campaign.

Description: Allows you to delete an existing campaign.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_delete
	[*api_output] => xml, json, or serialize
	[*id] => ID of the campaign you wish to delete
}

Example response:
{
	[result_code] => Whether or not the request was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Campaign deleted
...
$params = array(
	...
	// ID of the campaign you wish to delete
	'id'           => 1,
);
