<?php
/**
Title: Delete existing User Group.

Description: Allows you to delete an existing User Group.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => group_delete
	[*api_output] => xml, json, or serialize
	[*id] => ID of the User Group you wish to delete. Must be greater than 3.
...
Example response:
{
	...
	[result_message] => A custom message that appears explaining what happened. Example: Group deleted
...
$params = array(
	...
	'id'           => 4, // groups up to id=3 are locked
	'alt'          => 5, // group to update relations to
);
