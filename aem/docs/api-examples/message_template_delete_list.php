<?php
/**
Title: Delete multiple existing campaigns.

Description: Allows you to delete multiple campaigns at once.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => message_template_delete_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of the message templates you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Template deleted
...
$params = array(
	...
	// this is the action that deletes a message template based on the ID you provide
	'api_action'   => 'message_template_delete_list',
	...
	// a comma-separated list of IDs of message templates you wish to delete
	'ids'          => '1,2,3,4,5',
);
