<?php
/**
Title: View a single subscriber by looking up their hash.

Description: View a subscriber's details by matching their hash (unique encrypted string).
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => subscriber_view_hash
	[*api_output] => xml, json, or serialize
	[*hash] => Hash of the subscriber you are looking up. Example: '89acb12a60fd44897dfr23edb29f0a63'
}
...
$params = array(
	...
	// this is the action that fetches a subscriber info based on the hash you provide
	'api_action'   => 'subscriber_view_hash',
	...
	'hash'        => '89acb12a60fd44897dfr23edb29f0a63',
);
