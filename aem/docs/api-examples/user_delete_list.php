<?php
/**
Title: Delete multiple existing users.

Description: Allows you to delete multiple users at once.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => user_delete_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of the users you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: User deleted
...
$params = array(
	...
	// this is the action that deletes a user based on the ID you provide
	'api_action'   => 'user_delete_list',
	...
	// a comma-separated list of IDs of users you wish to delete
	'ids'          => '1,2,3,4,5',
);
