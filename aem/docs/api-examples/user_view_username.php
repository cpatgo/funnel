<?php
/**
Title: View a single user by looking up their username.

Description: View a single user's data by searching for a specific username.
...
Parameters (* denotes requirement):
{
	...
	[*username] => Username of the user you want to view
}
