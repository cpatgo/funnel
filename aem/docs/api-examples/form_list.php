<?php
/**
Title: View all subscription forms.

Description: View all subscription forms in the system. You will be able to see each individual form, and the settings associated with each, just like on the Integration page.
