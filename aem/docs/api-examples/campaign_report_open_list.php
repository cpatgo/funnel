<?php
/**
Title: View opens for a specific campaign.

Description: View all opens for a specific campaign. You will be able to see the email address of each open, much like on the Campaign Reports page.
...
Example response:
{
	[0] => Array
	  (
	    ...
	    [email] => Email address of the subscriber. Example: test@gmail.com
	    [tstamp] => Date and time that the open occurred. Example: 2011-03-07 11:41:43
	    [times] => Number of times opened. Example: 3
	  )
