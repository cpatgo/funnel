<?php
/**
Title: Obtain forward totals for a specific campaign.

Description: Obtain a total of all forwards for a specific campaign. This only returns the total amount of forwards, much like is seen along the top on the Campaign Reports page. To view individual forwarded email addresses, use campaign_report_forward_list.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_forward_totals
...
Example response:
{
	[forwards] => Total number of forwards for this campaign. Example: 1
	[uniqueforwards] => Total number of unique forwards for this campaign. Example: 2
	[didntforward] => Total number of subscribers who did not forward this campaign. Example: 2
	[avgforwards] => An average of subscribers who forwarded, versus those that did not. Example: 0.5000
