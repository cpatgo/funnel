<?php
/**
Title: View a single user by looking up their email address.

Description: View a single user's data by searching for a specific email address.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => user_view_email
	[*api_output] => xml, json, or serialize
	[*email] => Email address of the user you want to view
}

Example response:
{
  [id] => ID of this user. Example: 1
  [username] => Username of this user. Example: admin
  [password] => Password (hash) for this user. Example: 098f6bds4621d238973ca62b4f6
  [first_name] => First name of this user. Example: Matt
  [last_name] => Last name of this user. Example: Jones
  [email] => Email address of this user. Example: matt@testing.com
  [last_login] => Last log-in for this user. Example: 2011-03-02 14:46:40
  [sourceid] => 0
  [sourceupdated] =>
  [productset] =>
  [a_now] => 2011-03-14 10:29:06
  [groups] => Group ID's for this user. Example: 3
...
$params = array(
	...
	// email of the user you wish to fetch
	'email'     	 => '',
);
