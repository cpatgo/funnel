...
Example response:
{
  [0] => Array
    (
      ...
      [optin_from_name] => From Name for Opt-in confirmation email. Example: AwebDesk Email Marketing Software
...
%CONFIRMLINK%
      ...
      [optout_from_name] => From Name for Opt-out confirmation email. Example: AwebDesk Email Marketing Software
