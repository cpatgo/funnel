<?php
/**
Title: Delete existing subscription form.

Description: Allows you to delete an existing subscription form.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => form_delete
	[*api_output] => xml, json, or serialize
	[*id] => ID of the subscription form you wish to delete
}
...
$params = array(
	...
	// ID of the subscription form you wish to delete
	'id'           => 1002,
);
