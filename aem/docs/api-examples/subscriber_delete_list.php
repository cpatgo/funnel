<?php
/**
Title: Delete multiple existing subscribers.

Description: Allows you to delete multiple subscribers at once.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => subscriber_delete_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of the subscribers you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Subscriber deleted
...
$params = array(
	...
	// this is the action that deletes a subscriber based on the ID you provide
	'api_action'   => 'subscriber_delete_list',
	...
	// a comma-separated list of IDs of subscribers you wish to delete
	'ids'          => '1,2,3,4,5',

	// if you wish to delete the subscriber only from certain lists, list them here
	//'listids[123]' => 123,
	//'listids[345]' => 345,
);
