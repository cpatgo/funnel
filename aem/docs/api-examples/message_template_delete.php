<?php
/**
Title: Delete existing message template.

Description: Allows you to delete an existing message template.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => message_template_delete
	[*api_output] => xml, json, or serialize
	[*id] => ID of the message template you wish to delete
}
...
$params = array(
	...
	// ID of the message you wish to delete
	'id'           => 1,
);
