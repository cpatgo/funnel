<?php
/**
Title: View a single message template.

Description: View a message template data, such as internal name, subject, content, visibility, etc.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => message_template_view
	[*api_output] => xml, json, or serialize
	[*ids] => ID of the message template you want to view
}
...
$params = array(
	...
	// ID of the message template you wish to fetch
	'id'           => 1,
);
