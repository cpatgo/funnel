<?php
/**
Title: Obtain all totals for a specific campaign.

Description: Obtain all totals for a specific campaign, including links, forwards, opens, bounces, etc. This only provides the total amount. To view specific data, use the campaign_report_DATA_list API methods.
...
Example response:
{
  [ldate] => 2011-03-07 11:41:18
  [status] => Current status of the campaign. Example: 5
  [total_amt] => Total subscribers sent this campaign. Example: 4
  [send_amt] => Total amount sent. Example: 4
  [messageid] => The message ID used for this campaign
  [uniqueopens] => Total number of unique opens for this campaign. Example: 1
  [uniquelinkclicks] => Total number of unique link clicks for this campaign. Example: 4
  [subscriberclicks] => Total subscriber clicks for links in this campaign. Example: 1
  [unsubscribes] => Total unsubscribes for this campaign. Example: 0
  [forwards] => Total forwards for this campaign. Example: 0
  [updates] => Total updates for this campaign. Example: 0
  [totalbounces] => Total bounces for this campaign. Example: 3
  [socialshares] => Total social shares for this campaign. Example: 1
