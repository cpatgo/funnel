<?php
/**
Title: View a single subscriber.

Description: View only one subscriber's details.
...
Parameters (* denotes requirement):
{
	...
	[*ids] => ID of the subscriber you want to view
}
...
$params = array(
	...
	// ID of the subscriber you wish to fetch (email can be used here as well)
	'id'           => 1,
);
