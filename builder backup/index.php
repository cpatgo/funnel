    ...
    <body>
        ...
        <div class="menu" id="menu">
            ...
            <div class="main" id="main">
                ...
                <hr>
                <div class="text-center xsProjectLInk">
                    <a href="#xsImpModal" id="projectModal" class="btn btn-default btn-block" data-toggle="modal">Export/ Import Project</a>
                </div>
            </div><!-- /.main -->
        ...
        <div class="container">
            ...
            <header class="clearfix" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
                ...
                <a href="#previewModal" id="preview" data-toggle="modal" class="btn btn-inverse btn-embossed pull-right disabled actionButtons" style="margin-left: 10px; display: none"><span class="fui-window"></span> Preview</a>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-sm-6 sections-height">
                                ...
                                <div class="extra-small margin-top-40"><b>Note:</b> Import file should be builder Project save file.</div>
                            </div>
                        </div>
        ...
        <!-- ar1 delete all blocks before import project--> 
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Doc type" value="Your Page Title Goes here..">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="desc" class="col-sm-2 control-label">Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="desc" id="desc" placeholder="Add your site Description" rows="2" ></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="keyw" class="col-sm-2 control-label">Keyword</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="keyw" id="keyw" placeholder="Add Keyword Separated by commas " rows="2" ></textarea>
                                </div>
                            </div>
        ...
        <div id="loader">
            ...
            <span>Loading GLC Page Builder...</span>
            <img src="images/loading.gif" alt="Loading...">
        </div>
