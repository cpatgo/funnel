<?php
/**
Title: Obtain unsubscription totals for a specific campaign.

Description: Obtain unsubscription totals for a specific campaign. This only provides the total amount. To view specific data, use campaign_report_unsubscription_list API method.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_unsubscription_totals
...
Example response:
{
	[total_amt] => Total amount of subscribers sent this campaign. Example: 4
	[unsubscribes] => Total unsubscribes for this campaign. Example: 0
	[unsubreasons] => Total unsubscribe reasons for this campaign. Example: 0
