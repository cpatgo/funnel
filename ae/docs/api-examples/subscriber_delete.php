<?php
/**
Title: Delete existing subscriber.

Description: Allows you to delete an existing subscriber from the system.
...
Parameters (* denotes requirement):
{
	...
	[*id] => ID of the subscriber you wish to delete
}
...
$params = array(
	...
	// ID of the subscriber you wish to delete
	'id'           => 1,
