<?php
/**
Title: Delete multiple User Groups.

Description: Allows you to delete multiple User Groups.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => group_delete_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of the User Groups you wish to delete. Must all be greater than 3.
	[*alt] => ID of the User Group that existing relations should be moved to.
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Groups deleted
...
$params = array(
	...
	// this is the action that deletes a group based on the ID you provide
	'api_action'   => 'group_delete_list',
	...
	// a comma-separated list of IDs of groups you wish to delete
	'ids'          => '4,5,6', // groups up to id=3 are locked
);
