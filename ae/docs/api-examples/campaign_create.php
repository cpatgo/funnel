...
POST variables (* denotes requirement):
{
	...
	[*type] => Campaign type. Example: 'single', 'recurring', 'split', 'responder', 'reminder', 'special', 'deskrss', 'text'
	...
	[deskrss_interval] => If ActiveRSS. Same options as for recurring mailings. Example: 'day1'
...
$post = array(
	...
	// 'single', 'recurring', 'split', 'responder', 'reminder', 'special', 'deskrss', 'text'
	...
	'name'                      => 'Campaign Name',
	'sdate'                     => '2010-11-05 08:40:00', // the date when campaign should be sent out
	...
	//'trackreadsanalytics'     => 1, // set to 1 if you wish to use list's Google Analytics settings
	...
	/* IF ACTIVERSS */
	//'deskrss_interval'      => 'day1', // same options as for recurring mailings


	// send to lists:
	'p[0]'                       => 1, // example list ID
	//'p[1]'                     => 345, // some additional lists?

	// send message(s):
	'm[123]'                    => 100, // example message ID would be 123. 100 means send to 100% of subscribers
	/* IF SPLIT MAILING */
