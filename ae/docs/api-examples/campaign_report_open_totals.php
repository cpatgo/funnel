<?php
/**
Title: Obtain open totals for a specific campaign.

Description: Obtain a total of all opens for a specific campaign. This only returns the total amount of opens, much like is seen along the top on the Campaign Reports page. To view individual opens, use campaign_report_open_list.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_open_totals
...
Example response:
{
	[opens] => Total number of opens for this campaign. Example: 3
	[uniqueopens] => Total number of unique opens for this campaign. Example: 1
	[total_amt] => Total number of subscribers sent this campaign. Example: 4
	[unopens] => Total number of unopens for this campaign. Example: 3
