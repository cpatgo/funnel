<?php
/**
Title: Delete multiple existing email messages.

Description: Allows you to delete multiple email messages at once.
...
Parameters (* denotes requirement):
{
	...
	[*ids] => ID's (comma-separated) of the email messages you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Message deleted
...
$params = array(
	...
	// a comma-separated list of IDs of messages you wish to delete
	'ids'          => '1,2,3,4,5',
);
