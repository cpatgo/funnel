<?php /* Smarty version 2.6.12, created on 2016-07-18 12:02:44
         compiled from header.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'header.form.js', 1, false),array('modifier', 'js', 'header.form.js', 1, false),array('function', 'jsvar', 'header.form.js', 5, false),)), $this); ?>
var header_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to add Email Headers.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var header_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to edit Email Headers.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var header_form_str_cant_find   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Email Header not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
