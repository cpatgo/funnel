<?php /* Smarty version 2.6.12, created on 2016-07-11 16:58:35
         compiled from personalization.list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'personalization.list.htm', 7, false),array('modifier', 'truncate', 'personalization.list.htm', 9, false),array('function', 'adesk_headercol', 'personalization.list.htm', 30, false),)), $this); ?>
<div id="list" class="adesk_hidden">
  <form action="desk.php?action=personalization" method="GET" onsubmit="personalization_list_search(); return false">
    <div class=" table-responsive"><table class="table table-striped m-b-none dataTable"  cellspacing="0" cellpadding="0" width="100%">
      <tr class="adesk_table_header_options">
        <td>
    <select name="listid" id="JSListManager" size="1" onchange="personalization_list_search()">
    ...
    <div class=" table-responsive"><table class="table table-striped m-b-none dataTable"  width="100%" border="0" cellspacing="0" cellpadding="1">
      <thead id="list_head">
        <tr class="adesk_table_header">
          ...
          <td><?php echo smarty_function_adesk_headercol(array('action' => 'personalization','id' => '01','label' => ((is_array($_tmp='Tag')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp))), $this);?>
</td>
          <td><?php echo smarty_function_adesk_headercol(array('action' => 'personalization','id' => '02','label' => ((is_array($_tmp='Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp))), $this);?>
</td>
          <td width="150"><?php echo smarty_function_adesk_headercol(array('action' => 'personalization','id' => '04','label' => ((is_array($_tmp='Format')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp))), $this);?>
</td>
          <td width="100"><?php echo smarty_function_adesk_headercol(array('action' => 'personalization','id' => '03','label' => ((is_array($_tmp="List(s)")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp))), $this);?>
</td>
        </tr>
      </thead>
      <tbody id="list_table">
...
$this->_smarty_include(array('smarty_include_tpl_file' => "pagination.js.tpl.htm", 'smarty_include_vars' => array('tabelize' => 'personalization_list_tabelize','paginate' => 'personalization_list_paginate')));
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <span id="selectXPageAllBox" class="adesk_hidden">
      <span class="adesk_hidden"><?php echo ((is_array($_tmp="All personalizations are now selected.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
</span>
      <span class="adesk_hidden"><?php echo ((is_array($_tmp="All personalizations on this page are now selected.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
</span>
  ...
  <br />
  <?php if ($this->_tpl_vars['admin']['pg_template_add']): ?>
...
" onclick="adesk_ui_anchor_set('form-0')" />
  <?php endif; ?>
  <?php if ($this->_tpl_vars['admin']['pg_template_delete']): ?>
