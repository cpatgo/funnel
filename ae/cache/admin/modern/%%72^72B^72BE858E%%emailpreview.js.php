<?php /* Smarty version 2.6.12, created on 2016-07-18 11:58:18
         compiled from emailpreview.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'emailpreview.js', 12, false),array('modifier', 'js', 'emailpreview.js', 12, false),array('function', 'jsvar', 'emailpreview.js', 20, false),)), $this); ?>
...
var jsEmailMissing = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter the email address first.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var jsClientsMissing = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter the client you have a problem with first.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var jsMessageMissing = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please describe your problem first.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['clients2check'],'name' => 'clients2check'), $this);?>


<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['campaignid'],'name' => 'campaign_id'), $this);?>

<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['messageid'],'name' => 'message_id'), $this);?>
