<?php /* Smarty version 2.6.12, created on 2016-07-18 12:02:28
         compiled from bounce_management.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'bounce_management.list.js', 1, false),array('modifier', 'js', 'bounce_management.list.js', 1, false),array('function', 'jsvar', 'bounce_management.list.js', 12, false),)), $this); ?>
var bounce_management_list_none = '<?php echo ((is_array($_tmp=((is_array($_tmp="- No Bounce Management -")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var bounce_management_list_pipe = '<?php echo ((is_array($_tmp=((is_array($_tmp="- PIPE -")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var bounce_management_list_pop3 = '<?php echo ((is_array($_tmp=((is_array($_tmp="- POP3 -")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var bounce_management_confirm_run = '<?php echo ((is_array($_tmp=((is_array($_tmp="Connection has been successfully established.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
\n'
	+ '<?php echo ((is_array($_tmp=((is_array($_tmp="Bounce Check will be opened in a separate window.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
\n\n'
	+ '<?php echo ((is_array($_tmp=((is_array($_tmp="Do you wish to continue?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var bounce_management_table = new ACTable();
var bounce_management_list_sort = "01";
var bounce_management_list_offset = "0";
var bounce_management_list_filter = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['filterid']), $this);?>
;
