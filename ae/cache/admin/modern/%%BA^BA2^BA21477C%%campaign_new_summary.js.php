<?php /* Smarty version 2.6.12, created on 2016-07-08 14:23:07
         compiled from campaign_new_summary.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'campaign_new_summary.js', 1, false),array('modifier', 'alang', 'campaign_new_summary.js', 7, false),array('modifier', 'js', 'campaign_new_summary.js', 7, false),)), $this); ?>
var campaign_action_campaigns = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['campaigns']), $this);?>
;
var campaign_action_lists = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['lists']), $this);?>
;
var campaign_action_fields = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['fields']), $this);?>
;

var campaign_action_actioncount = 0;

var campaign_action_str_autoresponders = '<?php echo ((is_array($_tmp=((is_array($_tmp='Auto Responders')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_firstname = '<?php echo ((is_array($_tmp=((is_array($_tmp='First Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_lastname = '<?php echo ((is_array($_tmp=((is_array($_tmp='Last Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_mailings = '<?php echo ((is_array($_tmp=((is_array($_tmp='Mailings')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_send = '<?php echo ((is_array($_tmp=((is_array($_tmp='Send to')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_subdatebased = '<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber date based')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_subscribe = '<?php echo ((is_array($_tmp=((is_array($_tmp='Subscribe')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_unsubscribe = '<?php echo ((is_array($_tmp=((is_array($_tmp='Unsubscribe')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_action_str_update = '<?php echo ((is_array($_tmp=((is_array($_tmp='Update custom field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_spamcheck_str_scoreheader = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your campaign scored %s on our spam filter tests.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_spamcheck_str_msgheader = '<?php echo ((is_array($_tmp=((is_array($_tmp="Message #%s (%s): %s/%s")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_spamcheck_str_noissues = '<?php echo ((is_array($_tmp=((is_array($_tmp="No issues found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_inboxpreview_str_problems_no = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your email design looks great in all the major email clients!")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_inboxpreview_str_problems_yes = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your email design may look different in %s.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var campaign_summary_str_sdate = '<?php echo ((is_array($_tmp=((is_array($_tmp='Subscription Date')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_summary_str_cdate = '<?php echo ((is_array($_tmp=((is_array($_tmp='Creation Date')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_summary_str_customfield = '<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var campaign_str_finish  = '<?php echo ((is_array($_tmp=((is_array($_tmp='Finish')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_str_sendnow = '<?php echo ((is_array($_tmp=((is_array($_tmp='Send Now')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
