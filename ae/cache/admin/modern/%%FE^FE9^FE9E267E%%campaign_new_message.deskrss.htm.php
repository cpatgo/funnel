<?php /* Smarty version 2.6.12, created on 2016-07-08 14:19:52
         compiled from campaign_new_message.deskrss.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'campaign_new_message.deskrss.htm', 3, false),)), $this); ?>
			...
			<tr>
				<td>
					...
					<div class=" table-responsive"><table class="table table-striped m-b-none dataTable"  cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td width="30"><input type="text" id="deskrssloop" value="10" size="3" style="width:20px;" onkeypress="campaign_deskrss_loop_changed();" /></td>
							<td>
...
' onclick="adesk_dom_toggle_display('message_deskrss', 'block');" />
			<input type="hidden" value="html" id="deskrss4" />
