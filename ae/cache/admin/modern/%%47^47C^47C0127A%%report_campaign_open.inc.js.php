<?php /* Smarty version 2.6.12, created on 2016-07-08 14:48:21
         compiled from report_campaign_open.inc.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'report_campaign_open.inc.js', 1, false),array('modifier', 'js', 'report_campaign_open.inc.js', 1, false),)), $this); ?>
var report_campaign_open_str_totalopens = '<?php echo ((is_array($_tmp=((is_array($_tmp='Total Opens')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var report_campaign_open_str_uniqueopens = '<?php echo ((is_array($_tmp=((is_array($_tmp='Unique Opens')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var report_campaign_open_str_unopened = '<?php echo ((is_array($_tmp=((is_array($_tmp="Un-Opened")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
<?php echo '
