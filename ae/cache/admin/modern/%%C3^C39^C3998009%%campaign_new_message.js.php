<?php /* Smarty version 2.6.12, created on 2016-07-08 14:19:52
         compiled from campaign_new_message.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'campaign_new_message.js', 1, false),array('modifier', 'js', 'campaign_new_message.js', 1, false),array('function', 'jsvar', 'campaign_new_message.js', 14, false),)), $this); ?>
var campaign_message_str_noinfo = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter something in the From Name and From Email fields before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_nomail_from = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter a valid email address in the From Email field before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_nomail_reply2 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter a valid email address in the Reply To field before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_nosubj = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter something in the Subject field before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_nobody = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter something in the content area of your message before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_deskrss_nofeed = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have RSS personalization tags included into your messsage, or you have more than one RSS feed referenced. Please make sure that you have one RSS feed placed into your message before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_deskrss_noloop = '<?php echo ((is_array($_tmp=((is_array($_tmp="It seems like you haven't entered any LOOP tags to display your RSS feed items. Please add LOOP tags to your message before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_message_str_deskrss_mismatch = '<?php echo ((is_array($_tmp=((is_array($_tmp="It seems like you haven't entered valid RSS personalization tags. Some tags seem to be missing, and your RSS feed would not be properly displayed. Please correct this before continuing.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var campaign_fetch_str_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp='Insert')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_fetch_str_save = '<?php echo ((is_array($_tmp=((is_array($_tmp='Save')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

adesk_editor_init_word_object.plugins += ",fullpage";
<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['message'],'name' => 'message_obj'), $this);?>
;
<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['message']['html'],'name' => 'default_editor_value'), $this);?>
;
