<?php /* Smarty version 2.6.12, created on 2016-07-08 14:14:32
         compiled from campaign.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'campaign.list.js', 1, false),array('modifier', 'js', 'campaign.list.js', 1, false),array('function', 'jsvar', 'campaign.list.js', 26, false),)), $this); ?>
var campaign_list_str_confirm_enable = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to re-enable this Scheduled Campaign?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_disable = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to disable this Scheduled Campaign?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_run = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to run this Campaign?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_stop = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to stop this Campaign?  Once you stop a campaign you CANNOT resume it.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_pause = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to pause this Campaign?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_resume = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to resume this Campaign?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_confirm_send = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to send this Campaign now?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_alert_scheduled = '<?php echo ((is_array($_tmp=((is_array($_tmp="This will turn off your scheduled campaign. You will have the option to resume/enable the scheduled campaign after doing this.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_view_reports = '<?php echo ((is_array($_tmp=((is_array($_tmp='View Reports')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_export_none = '<?php echo ((is_array($_tmp=((is_array($_tmp="You have selected no campaigns to export. Please select campaign(s) first.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_completed = '<?php echo ((is_array($_tmp=((is_array($_tmp="Completed: ")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage = '<?php echo ((is_array($_tmp=((is_array($_tmp="Stage: ")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage_completed = '<?php echo ((is_array($_tmp=((is_array($_tmp="Campaign Completed!")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage_cleanup = '<?php echo ((is_array($_tmp=((is_array($_tmp="Almost Done (Cleaning Up)")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage_send = '<?php echo ((is_array($_tmp=((is_array($_tmp='Sending Emails')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage_transfer = '<?php echo ((is_array($_tmp=((is_array($_tmp='Preparing Subscribers')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_stage_winner = '<?php echo ((is_array($_tmp=((is_array($_tmp='Waiting for winner to continue sending')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_recur = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign is set to recur every %s.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_recur_rss = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign will check for new RSS feeds every %s.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_sent_unsub = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign will be sent %s after a person unsubscribes.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_sent_sub = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign will be sent %s after a person subscribes.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_sent_match = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign will be sent when the field %s matches the current date %s.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_sendnow = '<?php echo ((is_array($_tmp=((is_array($_tmp='Send Now')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_list_str_approvalnotice = '<?php echo ((is_array($_tmp=((is_array($_tmp="This campaign is currently awaiting approval. Some campaigns (especially for new accounts) may require approval. This allows us to ensure the best deliverability for all of our users. Approvals are typically handled within an hour.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['recur_intervals'],'name' => 'campaign_list_str_intervals'), $this);?>


var campaign_table = new ACTable();
var campaign_list_sort = "01D";
var campaign_list_offset = "0";
var campaign_list_filter = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['filterid']), $this);?>
;
var campaign_list_sort_discerned = false;

var campaign_reports = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['reportsOnly']), $this);?>
;

var canSend = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['canSendCampaign']), $this);?>
;
