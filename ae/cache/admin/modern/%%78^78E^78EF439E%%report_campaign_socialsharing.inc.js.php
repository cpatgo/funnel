<?php /* Smarty version 2.6.12, created on 2016-07-08 14:48:21
         compiled from report_campaign_socialsharing.inc.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'report_campaign_socialsharing.inc.js', 1, false),array('modifier', 'alang', 'report_campaign_socialsharing.inc.js', 2, false),array('modifier', 'js', 'report_campaign_socialsharing.inc.js', 2, false),)), $this); ?>
<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['socialsharing_enabled'],'name' => 'socialsharing_enabled'), $this);?>

var strFacebook1 = '<?php echo ((is_array($_tmp=((is_array($_tmp='liked this campaign on Facebook on')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var strTwitter1 = '<?php echo ((is_array($_tmp=((is_array($_tmp='shared this campaign on Twitter on')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var strOn = '<?php echo ((is_array($_tmp=((is_array($_tmp='on')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
