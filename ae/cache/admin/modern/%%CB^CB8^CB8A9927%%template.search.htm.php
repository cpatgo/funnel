...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'template.search.htm', 6, false),array('modifier', 'truncate', 'template.search.htm', 22, false),array('modifier', 'help', 'template.search.htm', 25, false),)), $this); ?>
<div id="search" class="adesk_modal_search" align="center" style="display:none">
  <div class="adesk_modal_inner">
    <form method="GET" onsubmit="template_search(); return false">
...
' onclick="template_search()" class="adesk_button_ok" />
      <input type="button" value='<?php echo ((is_array($_tmp='Cancel')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
' onclick="adesk_dom_toggle_display('search', 'block'); adesk_ui_anchor_set(template_list_anchor())"/>
    </div>
  </div>
</div>
