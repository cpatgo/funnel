<?php /* Smarty version 2.6.12, created on 2016-07-08 14:41:25
         compiled from cron.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'cron.list.js', 1, false),array('modifier', 'js', 'cron.list.js', 1, false),array('function', 'jsvar', 'cron.list.js', 10, false),)), $this); ?>
var cron_list_str_confirm_run = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to run this Cron Job?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var cron_list_str_confirm_enable = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to enable this Cron Job?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var cron_list_str_confirm_disable = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you wish to disable this Cron Job?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
...
var cron_protected = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['cron_protected']), $this);?>
;
