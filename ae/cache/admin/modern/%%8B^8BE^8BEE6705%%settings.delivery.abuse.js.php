<?php /* Smarty version 2.6.12, created on 2016-07-08 14:11:51
         compiled from settings.delivery.abuse.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'settings.delivery.abuse.js', 1, false),array('modifier', 'js', 'settings.delivery.abuse.js', 1, false),)), $this); ?>
var settings_delivery_str_viewabuse = '<?php echo ((is_array($_tmp=((is_array($_tmp='View Abuse Reports')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
