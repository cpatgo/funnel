<?php /* Smarty version 2.6.12, created on 2016-07-08 14:41:25
         compiled from cron.search.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'cron.search.htm', 6, false),)), $this); ?>
<div id="search" class="adesk_modal_search" align="center" style="display:none">
  <div class="adesk_modal_inner">
    <form method="GET" onsubmit="cron_search(); return false">
...
' onclick="adesk_dom_toggle_display('search', 'block'); adesk_ui_anchor_set(cron_list_anchor())"/>
    </div>
  </div>
</div>
