<?php /* Smarty version 2.6.12, created on 2016-07-08 14:14:43
         compiled from campaign_new.sharedv64.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'campaign_new.sharedv64.js', 1, false),array('modifier', 'alang', 'campaign_new.sharedv64.js', 5, false),array('modifier', 'js', 'campaign_new.sharedv64.js', 5, false),)), $this); ?>
var campaign_obj = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['campaign']), $this);?>
;

var campaign_step = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['step']), $this);?>
;

var campaign_header_str_type = '<?php echo ((is_array($_tmp=((is_array($_tmp='Type')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_list = '<?php echo ((is_array($_tmp=((is_array($_tmp='Lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_message = '<?php echo ((is_array($_tmp=((is_array($_tmp='Message')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_messages = '<?php echo ((is_array($_tmp=((is_array($_tmp='Messages')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_summary = '<?php echo ((is_array($_tmp=((is_array($_tmp="Summary & Options")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_done = '<?php echo ((is_array($_tmp=((is_array($_tmp='Done')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_noname = '<?php echo ((is_array($_tmp=((is_array($_tmp='Create a New Campaign')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_header_str_name = '<?php echo ((is_array($_tmp=((is_array($_tmp="Campaign: %s")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
