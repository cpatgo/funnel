<?php /* Smarty version 2.6.12, created on 2016-07-08 14:11:34
         compiled from user.group.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'user.group.js', 1, false),array('modifier', 'js', 'user.group.js', 1, false),)), $this); ?>
var user_group_str_blankname = '<?php echo ((is_array($_tmp=((is_array($_tmp="You must give a name to this group.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
