<?php /* Smarty version 2.6.12, created on 2016-07-18 12:03:31
         compiled from subscriber_action.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'subscriber_action.list.js', 4, false),array('modifier', 'alang', 'subscriber_action.list.js', 6, false),)), $this); ?>
var subscriber_action_table = new ACTable();
var subscriber_action_list_sort = "01";
var subscriber_action_list_offset = "0";
var subscriber_action_list_filter = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['filterid']), $this);?>
;
var subscriber_action_list_sort_discerned = false;
var subscriber_action_list_str_any = '<?php echo ((is_array($_tmp='Any')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
';
