<?php /* Smarty version 2.6.12, created on 2016-07-08 14:15:31
         compiled from campaign_new_list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'campaign_new_list.js', 1, false),array('modifier', 'js', 'campaign_new_list.js', 1, false),)), $this); ?>
var campaign_str_nosegment = '<?php echo ((is_array($_tmp=((is_array($_tmp='No segment')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
...
var campaign_list_totals = <?php echo '{}'; ?>
;
<?php $_from = $this->_tpl_vars['lists']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['e']):
?>
campaign_list_totals[<?php echo $this->_tpl_vars['e']['id']; ?>
] = <?php echo $this->_tpl_vars['e']['count']; ?>
;
<?php endforeach; endif; unset($_from); ?>

// Filter code
var filter_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to add filters.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to edit filters.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_cant_find   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Filter not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_edit        = '<?php echo ((is_array($_tmp=((is_array($_tmp='Edit')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_noname      = '<?php echo ((is_array($_tmp=((is_array($_tmp="You did not provide a name for this filter.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_groupn      = '<?php echo ((is_array($_tmp=((is_array($_tmp="Group %d")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_status      = '<?php echo ((is_array($_tmp=((is_array($_tmp='Status')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_is          = '<?php echo ((is_array($_tmp=((is_array($_tmp='Is')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_isnot       = '<?php echo ((is_array($_tmp=((is_array($_tmp='Is not')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_isoneof     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Is one of')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_contains    = '<?php echo ((is_array($_tmp=((is_array($_tmp='Contains')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_doesntcontain = '<?php echo ((is_array($_tmp=((is_array($_tmp='Does not contain')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_greater     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Greater than')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_less        = '<?php echo ((is_array($_tmp=((is_array($_tmp='Less than')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_greatereq   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Greater than or equal to')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_lesseq      = '<?php echo ((is_array($_tmp=((is_array($_tmp='Less than or equal to')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_active      = '<?php echo ((is_array($_tmp=((is_array($_tmp='Active')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_notactive   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Not active')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_nolists     = '<?php echo ((is_array($_tmp=((is_array($_tmp="You did not mark any lists that this filter would use.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_checked     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Checked')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_unchecked   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Unchecked')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var filter_form_str_anylink     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Any link')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_anylist     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Any list')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_anycampaign = '<?php echo ((is_array($_tmp=((is_array($_tmp='Any campaign')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var filter_form_str_subscribed  = '<?php echo ((is_array($_tmp=((is_array($_tmp='Subscribed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_unsubscribed = '<?php echo ((is_array($_tmp=((is_array($_tmp='Unsubscribed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_confirmed   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Confirmed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_unconfirmed = '<?php echo ((is_array($_tmp=((is_array($_tmp='Unconfirmed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_bounced = '<?php echo ((is_array($_tmp=((is_array($_tmp='Bounced')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var filter_form_str_facebook    = '<?php echo ((is_array($_tmp=((is_array($_tmp='Facebook')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_twitter     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Twitter')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_digg        = '<?php echo ((is_array($_tmp=((is_array($_tmp='Digg')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_delicious   = '<?php echo ((is_array($_tmp=((is_array($_tmp="del.icio.us")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_greader     = '<?php echo ((is_array($_tmp=((is_array($_tmp='Google Reader')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_reddit      = '<?php echo ((is_array($_tmp=((is_array($_tmp='Reddit')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var filter_form_str_stumbleupon = '<?php echo ((is_array($_tmp=((is_array($_tmp='StumbleUpon')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var filter_form_str_noname      = '<?php echo ((is_array($_tmp=((is_array($_tmp="You must enter a name for this segment.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
...
function campaign_fields_cb(ary) {
	...
	for (var i = 0; i < dropdowns.length; i++) {
		...
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:email" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Email Address')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:first_name" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='First Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:last_name" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Last Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:*fullname" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Full Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:*cdate" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Date Subscribed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:*ctime" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Time Subscribed')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:*ip" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='IP Address')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "standard:*status" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Subscriber Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Status')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));

		if (typeof ary.row != "undefined") {
			for (var j = 0; j < ary.row.length; j++) {
				dropdowns[i].appendChild(Builder.node("option", { value: sprintf("custom:%s", ary.row[j].id) }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Custom Field')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - '<?php echo ' + ary.row[j].title));
			}
		}

		dropdowns[i].appendChild(Builder.node("option", { value: "action:linkclicked" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Has clicked on a link')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:linknotclicked" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Has not clicked on a link')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:opened" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp="Has opened/read")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:notopened" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp="Has not opened/read")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:social" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Has shared socially')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:inlist" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='In list')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:notinlist" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Not in list')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:forwarded" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Has forwarded')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
		dropdowns[i].appendChild(Builder.node("option", { value: "action:notforwarded" }, '; ?>
'<?php echo ((is_array($_tmp=((is_array($_tmp='Action')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
 - <?php echo ((is_array($_tmp=((is_array($_tmp='Has not forwarded')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'<?php echo '));
	}
}
...
?>
objProps.value = <?php echo $this->_tpl_vars['c']['id']; ?>
;
filter_form_campaigns.push(Builder.node('option', objProps, '<?php echo ((is_array($_tmp=$this->_tpl_vars['c']['name'])) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
'));
