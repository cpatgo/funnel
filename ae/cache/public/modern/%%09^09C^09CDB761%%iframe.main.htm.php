<?php /* Smarty version 2.6.12, created on 2016-07-18 12:17:13
         compiled from iframe.main.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'i18n', 'iframe.main.htm', 8, false),array('modifier', 'plang', 'iframe.main.htm', 54, false),array('modifier', 'js', 'iframe.main.htm', 72, false),array('function', 'adesk_js', 'iframe.main.htm', 12, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
<title><?php if (isset ( $this->_tpl_vars['message'] ) && isset ( $this->_tpl_vars['message']['subject'] )):  echo $this->_tpl_vars['message']['subject'];  else:  echo $this->_tpl_vars['site']['site_name']; ?>
 - <?php echo $this->_tpl_vars['pageTitle'];  endif; ?></title>
...
<body>
  ...
  <?php if ($this->_tpl_vars['action'] == 'social'): ?>
  <div id="fb-root"></div>
  <script type="text/javascript" src="http://connect.facebook.net/en_US/all.js"></script>
  <script>
	FB.init(<?php echo '{'; ?>

	  appId: '<?php echo $this->_tpl_vars['site']['facebook_app_id']; ?>
',
	  status: true,
	  cookie: true,
	  xfbml: true
