...
var subscriber_list_filter = {jsvar var=$filterid};
var subscriber_list_list_filter = {jsvar var=$listfilter};
var subscriber_list_sort_discerned = false;
var subscriber_list_segment = {$smarty.get.filterid|default:'0'};

var subscriber_list_str_newlist = '{"New List"|alang|js}';
var subscriber_list_str_optin_resend = '{"Send Email Reminder"|alang|js}';

{jsvar name=subscriber_fields var=$fields}
