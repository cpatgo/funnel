{* include file="subscriber_view.mailing.js" *}
{include file="subscriber_view.log.js"}

{jsvar name=subscriber_view_id var=$subscriber.id}
{jsvar name=subscriber_view_email var=$subscriber.email}
{jsvar name=subscriber_view_hash var=$subscriber.hash}
...
var subscriber_view_str_firstname = '{"First name"|alang|js}';
var subscriber_view_str_lastname  = '{"Last name"|alang|js}';
var subscriber_view_str_status = '{"Status"|alang|js}';
var subscriber_view_str_unsubscribed = '{"Unsubscribed"|alang|js}';
var subscriber_view_str_unconfirmed = '{"Unconfirmed"|alang|js}';
var subscriber_view_str_subscribed = '{"Subscribed"|alang|js}';
var subscriber_view_str_bounced = '{"Bounced"|alang|js}';

var subscriber_view_str_email_invalid = '{"Email address you have entered does not seem to be valid."|alang|js}';
