  ...
  switch (pageMode) {
    ...
    case 1:
      if (safari) {
        ...
        if (!operaSwitch && document.documentElement && document.documentElement.clientHeight > 0) {
  ...
  switch (pageMode) {
    ...
    case 1:
      if (safari) {
        ...
        if (!operaSwitch && document.documentElement && document.documentElement.clientWidth > 0) {
...
function addMenuItem(menuItemObj) { // Public method
  if (menuItemObj.displayText == "-") {
    ...
    itemElm.innerHTML = menuItemObj.displayText;
...
function activatePopUpMenuBy() { // Public method
  ...
  if (showValue == 1 || showValue == 2 || hideValue == 1 || hideValue == 2) {
    document.onassetsmenu = rightClickHandler;
  }
}
...
var operaSwitch = isOpera(); // Private field
