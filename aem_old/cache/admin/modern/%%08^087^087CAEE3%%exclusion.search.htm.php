<?php /* Smarty version 2.6.12, created on 2016-07-28 11:05:46
         compiled from exclusion.search.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'exclusion.search.htm', 6, false),array('modifier', 'truncate', 'exclusion.search.htm', 22, false),array('modifier', 'help', 'exclusion.search.htm', 25, false),)), $this); ?>
<div id="search" class="adesk_modal_search" align="center" style="display:none">
  <div class="adesk_modal_inner">
    <form method="GET" onsubmit="exclusion_search(); return false">
...
' onclick="exclusion_search()" class="adesk_button_ok" />
      <input type="button" value='<?php echo ((is_array($_tmp='Cancel')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
' onclick="adesk_dom_toggle_display('search', 'block'); adesk_ui_anchor_set(exclusion_list_anchor())"/>
    </div>
  </div>
</div>
