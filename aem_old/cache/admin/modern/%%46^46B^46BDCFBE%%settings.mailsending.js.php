<?php /* Smarty version 2.6.12, created on 2016-07-08 14:11:51
         compiled from settings.mailsending.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'settings.mailsending.js', 1, false),array('modifier', 'js', 'settings.mailsending.js', 1, false),array('modifier', 'escape', 'settings.mailsending.js', 8, false),array('function', 'jsvar', 'settings.mailsending.js', 11, false),)), $this); ?>
var mail_sending_rand_alert = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please Note:\nUsing randomized sending order can cause your sending to take longer.\nIf you are looking for high sending speed we suggest any other sending order.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_type_mail = '<?php echo ((is_array($_tmp=((is_array($_tmp="Mail()")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_type_smtp = '<?php echo ((is_array($_tmp=((is_array($_tmp='SMTP')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_notfound = '<?php echo ((is_array($_tmp=((is_array($_tmp="Mailer not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_email_invalid = '<?php echo ((is_array($_tmp=((is_array($_tmp="Please enter a valid email address.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_testsend_error = '<?php echo ((is_array($_tmp=((is_array($_tmp="There was an ERROR while sending your test email.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var mail_sending_throttle_check = '<?php echo ((is_array($_tmp=((is_array($_tmp="You can not enter a value greater than 4 minutes (240 seconds).")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var serverLimit = '<?php echo ((is_array($_tmp=((is_array($_tmp="Server is the limit.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
';
var noGroupsSelected = '<?php echo ((is_array($_tmp=((is_array($_tmp="You did not select any groups. Do you wish to use all groups instead?")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
';

<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['mailconnections'],'name' => 'mailers'), $this);?>

<?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['mailconnectionscnt'],'name' => 'mailerscnt'), $this);?>
