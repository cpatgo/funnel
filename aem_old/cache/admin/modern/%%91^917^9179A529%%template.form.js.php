<?php /* Smarty version 2.6.12, created on 2016-07-08 14:47:32
         compiled from template.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'template.form.js', 1, false),array('modifier', 'js', 'template.form.js', 1, false),array('function', 'jsvar', 'template.form.js', 12, false),)), $this); ?>
var template_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to add templates')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
...
';
var template_form_str_noname      = '<?php echo ((is_array($_tmp=((is_array($_tmp="You must give this template a name.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
