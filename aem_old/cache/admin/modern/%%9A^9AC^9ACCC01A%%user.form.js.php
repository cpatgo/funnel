<?php /* Smarty version 2.6.12, created on 2016-07-08 14:11:34
         compiled from user.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'user.form.js', 1, false),array('modifier', 'alang', 'user.form.js', 2, false),array('modifier', 'js', 'user.form.js', 2, false),)), $this); ?>
var adesk_admin_ismaingroup = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['adesk_admin_ismaingroup']), $this);?>

var user_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to edit users')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var user_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to add users')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
<?php echo '
var user_form_id = 0;
