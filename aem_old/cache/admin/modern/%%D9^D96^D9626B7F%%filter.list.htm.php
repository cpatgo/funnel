<?php /* Smarty version 2.6.12, created on 2016-07-27 12:32:21
         compiled from filter.list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'filter.list.htm', 7, false),array('modifier', 'truncate', 'filter.list.htm', 9, false),array('function', 'adesk_headercol', 'filter.list.htm', 29, false),)), $this); ?>
<div id="list" class="adesk_hidden_ie">
  <form action="desk.php?action=filter" method="GET" onsubmit="filter_list_search(); return false">
    <div class=" table-responsive"><table class="table table-striped m-b-none dataTable"  cellspacing="0" cellpadding="0" width="100%">
      <tr class="adesk_table_header_options">
		<td>
		  <select name="listid" id="JSListManager" size="1" onchange="filter_list_search()">
...
' id="list_clear" style="display:none" onclick="filter_list_clear()" />
    ...
    <div class=" table-responsive"><table class="table table-striped m-b-none dataTable"  width="100%" border="0" cellspacing="0" cellpadding="1">
      <thead id="list_head">
        <tr class="adesk_table_header">
		  ...
		  <td><?php echo smarty_function_adesk_headercol(array('action' => 'filter','id' => '01','label' => ((is_array($_tmp='Name')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp))), $this);?>
</td>
        </tr>
      </thead>
      <tbody id="list_table">
    ...
    <div id="list_noresults" class="adesk_hidden_ie">
...
$this->_smarty_include(array('smarty_include_tpl_file' => "pagination.js.tpl.htm", 'smarty_include_vars' => array('tabelize' => 'filter_list_tabelize','paginate' => 'filter_list_paginate')));
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <span id="selectXPageAllBox" class="adesk_hidden">
      <span class="adesk_hidden_ie"><?php echo ((is_array($_tmp="All filters are now selected.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
</span>
      <span class="adesk_hidden_ie"><?php echo ((is_array($_tmp="All filters on this page are now selected.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
</span>
      <a class="adesk_hidden_ie" href="#" onclick="return adesk_form_check_selection_xpage(this.parentNode);"><?php echo ((is_array($_tmp="Click here to select all %s items.")) ? $this->_run_mod_handler('alang', true, $_tmp, '<span></span>') : smarty_modifier_alang($_tmp, '<span></span>')); ?>
</a>
    </span>
  </form>

  <br />
  <?php if ($this->_tpl_vars['admin']['pg_subscriber_filters']): ?>
