<?php /* Smarty version 2.6.12, created on 2016-07-08 14:48:24
         compiled from /home/cielbleu/public_html/glcv2/aem/manage/templates/graph/open_pie.xml */ ?>
<?php echo '<?xml'; ?>
...
<settings> 
  ...
  <pie>
	...
	<radius>34%</radius>                                       <!-- [25%] (Number / Number%) -->
	...
	<start_angle>0</start_angle>                               <!-- [90] (0-360) angle of a first slice. This will work properly only if <pie><height> is set to 0. If height is > 0, then there can be two angles only: 90 and 270 -->
  ...
  <animation>
	...
	<pull_out_radius>10%</pull_out_radius>                       <!-- [20%] (Number / Number%) how far pie slices should be pulled-out then user clicks on them -->
  ...
  <legend>                                                    <!-- LEGEND -->
	...
	<values>                                                  <!-- VALUES -->          
	  ...
	  <width>44</width>                                         <!-- [] (Number) width of value text (use it if you want to align all values to the right, othervise leave empty) -->
	  <?php echo '
  ...
  <data>
	<pie>
	  <?php $_from = $this->_tpl_vars['pie']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['p']):
?>
	  <slice title="<?php echo $this->_tpl_vars['p']['title']; ?>
"<?php if (isset ( $this->_tpl_vars['p']['pullout'] )): ?> pull_out="true"<?php endif;  if (isset ( $this->_tpl_vars['p']['url'] )): ?> url="<?php echo $this->_tpl_vars['p']['url']; ?>
"<?php endif;  if (isset ( $this->_tpl_vars['p']['desc'] )): ?> description="<?php echo $this->_tpl_vars['p']['desc']; ?>
"<?php endif;  if (isset ( $this->_tpl_vars['p']['alpha'] )): ?> alpha="<?php echo $this->_tpl_vars['p']['alpha']; ?>
"<?php endif; ?>><?php echo $this->_tpl_vars['p']['val']; ?>
</slice>
