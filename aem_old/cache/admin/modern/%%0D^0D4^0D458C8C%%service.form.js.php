<?php /* Smarty version 2.6.12, created on 2016-07-08 16:21:25
         compiled from service.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'service.form.js', 1, false),array('modifier', 'js', 'service.form.js', 1, false),array('function', 'jsvar', 'service.form.js', 5, false),)), $this); ?>
var service_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to add External Services.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var service_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp="You do not have permission to edit External Services.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var service_form_str_cant_find   = '<?php echo ((is_array($_tmp=((is_array($_tmp="External Service not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

<?php echo smarty_function_jsvar(array('name' => 'user_password','var' => $this->_tpl_vars['user_password']), $this);?>
