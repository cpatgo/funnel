<?php /* Smarty version 2.6.12, created on 2016-07-27 12:32:21
         compiled from filter.delete.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'filter.delete.htm', 3, false),)), $this); ?>
<div id="delete" class="adesk_modal_delete" align="center" style="display: none">
  <div class="adesk_modal_inner">
    <h3 class="m-b"><?php echo ((is_array($_tmp="Delete List Segment(s)")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
</h3>
...
" onclick="filter_delete(filter_delete_id)" />
...
" onclick="adesk_dom_toggle_display('delete', 'block'); adesk_ui_anchor_set(filter_list_anchor())" />
    </div>
  </div>
</div>