<?php /* Smarty version 2.6.12, created on 2016-07-08 16:53:15
         compiled from list.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'list.form.js', 1, false),array('modifier', 'js', 'list.form.js', 1, false),array('function', 'jsvar', 'list.form.js', 33, false),)), $this); ?>
var list_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to add lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to edit lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_cant_find   = '<?php echo ((is_array($_tmp=((is_array($_tmp="List not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter1   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Could not obtain permission from Twitter. Please try again shortly.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter2   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Successfully confirmed permission from Twitter.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter3   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Twitter authentication error')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter4   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Connecting')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter5   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Retrieving your Twitter account details')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter6   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Copying Twitter tokens to all lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter7   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Successfully mirrored Twitter tokens to all lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter8   = '<?php echo ((is_array($_tmp=((is_array($_tmp='Failed to mirror Twitter tokens to all lists')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_twitter9   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Are you sure you want to mirror this Twitter account to all lists? This will overwrite any existing Twitter accounts.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var list_form_str_senderinfo       = '<?php echo ((is_array($_tmp=((is_array($_tmp="You can not continue until you enter Sender Information.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_email = '<?php echo ((is_array($_tmp=((is_array($_tmp="Sender Information needs to contain postal, not e-mail address.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_url   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Sender Information needs to contain postal, not web address.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';

var list_form_str_senderinfo_company = '<?php echo ((is_array($_tmp=((is_array($_tmp='Your Company')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_address = '<?php echo ((is_array($_tmp=((is_array($_tmp='Address')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_apt = '<?php echo ((is_array($_tmp=((is_array($_tmp="Apt/Suite")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_city = '<?php echo ((is_array($_tmp=((is_array($_tmp='City')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_state = '<?php echo ((is_array($_tmp=((is_array($_tmp='State')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_zip = '<?php echo ((is_array($_tmp=((is_array($_tmp='Zip')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var list_form_str_senderinfo_country = '<?php echo ((is_array($_tmp=((is_array($_tmp='Country')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
