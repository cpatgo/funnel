<?php /* Smarty version 2.6.12, created on 2016-07-18 12:03:31
         compiled from campaign_new.actions.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'campaign_new.actions.js', 1, false),array('modifier', 'js', 'campaign_new.actions.js', 1, false),)), $this); ?>
var campaign_actions_str_linkclicked = '<?php echo ((is_array($_tmp=((is_array($_tmp="When this link is clicked...")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var campaign_actions_str_readopen    = '<?php echo ((is_array($_tmp=((is_array($_tmp="When this campaign is opened...")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
