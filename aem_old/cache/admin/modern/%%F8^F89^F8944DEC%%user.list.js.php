<?php /* Smarty version 2.6.12, created on 2016-07-08 14:11:34
         compiled from user.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'user.list.js', 1, false),)), $this); ?>
var user_list_str_edit = '<?php echo ((is_array($_tmp='Edit')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
';
var user_list_str_delete = '<?php echo ((is_array($_tmp='Delete')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)); ?>
';
<?php echo '
