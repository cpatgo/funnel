<?php /* Smarty version 2.6.12, created on 2016-07-08 17:09:18
         compiled from form.form.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'form.form.js', 1, false),array('modifier', 'js', 'form.form.js', 1, false),array('function', 'jsvar', 'form.form.js', 17, false),)), $this); ?>
var form_form_str_cant_insert = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to add Subscription Forms')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_str_cant_update = '<?php echo ((is_array($_tmp=((is_array($_tmp='You do not have permission to edit Subscription Forms')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_str_cant_find   = '<?php echo ((is_array($_tmp=((is_array($_tmp="Subscription Form not found.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_sub1 = '<?php echo ((is_array($_tmp=((is_array($_tmp="You have successfully been subscribed to this list.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_sub2 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your subscription is awaiting confirmation. Please check your email to confirm.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_sub3 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your subscription has been confirmed.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_sub4 = '<?php echo ((is_array($_tmp=((is_array($_tmp="An error occurred while trying to subscribe:")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_unsub1 = '<?php echo ((is_array($_tmp=((is_array($_tmp="You have successfully been unsubscribed to this list.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_unsub2 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your unsubscription is awaiting confirmation. Please check your email to confirm.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_unsub3 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your unsubscription has been confirmed.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_unsub4 = '<?php echo ((is_array($_tmp=((is_array($_tmp="An error occurred while trying to unsubscribe:")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_up1 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your request to update subscription details has been processed.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_custommessage_up2 = '<?php echo ((is_array($_tmp=((is_array($_tmp="Your subscription details have been updated.")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_add = '<?php echo ((is_array($_tmp=((is_array($_tmp="Add & Continue")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
var form_form_edit = '<?php echo ((is_array($_tmp=((is_array($_tmp="Update & Continue")) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
