<?php /* Smarty version 2.6.12, created on 2016-07-08 16:53:15
         compiled from list.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'alang', 'list.list.js', 1, false),array('modifier', 'js', 'list.list.js', 1, false),)), $this); ?>
var list_list_str_copy = '<?php echo ((is_array($_tmp=((is_array($_tmp='Copy')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
<?php echo '
