<?php /* Smarty version 2.6.12, created on 2016-07-27 12:32:21
         compiled from filter.list.js */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'jsvar', 'filter.list.js', 4, false),array('modifier', 'alang', 'filter.list.js', 6, false),array('modifier', 'js', 'filter.list.js', 6, false),)), $this); ?>
var filter_table = new ACTable();
var filter_list_sort = "01";
var filter_list_offset = "0";
var filter_list_filter = <?php echo smarty_function_jsvar(array('var' => $this->_tpl_vars['filterid']), $this);?>
;
var filter_list_sort_discerned = false;
var filter_list_str_showsubs = '<?php echo ((is_array($_tmp=((is_array($_tmp='Show subscribers')) ? $this->_run_mod_handler('alang', true, $_tmp) : smarty_modifier_alang($_tmp)))) ? $this->_run_mod_handler('js', true, $_tmp) : smarty_modifier_js($_tmp)); ?>
';
