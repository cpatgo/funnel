<?php
/**
Title: Obtain social sharing totals for a specific campaign.

Description: Obtain a total of all social shares for a specific campaign. This only returns the total amount of social shares, much like is seen along the top on the Campaign Reports page. To view individual social shares, use campaign_report_socialsharing_list.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_socialsharing_totals
