...
Parameters (* denotes requirement):
{
	...
	[*ids] => ID's (comma-separated) of the campaigns you wish to delete
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Campaigns deleted
...
$params = array(
	...
	// this is the action that deletes a campaign based on the ID you provide
	'api_action'   => 'campaign_delete_list',
	...
	// a comma-separated list of IDs of campaigns you wish to delete
	'ids'          => '1,2,3,4,5',
);
