<?php
/**
Title: Set a campaign's status.

Description: Update a campaign's status directly.
...
Parameters (* denotes requirement):
{
	...
	[*id] => ID of the campaign you wish to change status for
	[*status] => New status. Examples: 0 = draft, 1 = scheduled, 2 = sending, 3 = paused, 4 = stopped, 5 = completed
}

Example response:
{
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Campaign updated
...
$params = array(
	...
	// this is the action that changes a status of a campaign based on the ID you provide
	'api_action'   => 'campaign_status',
	...
	// ID of the campaign you wish to change status for
	'id'           => 1,

	// new status
	// 0: draft, 1: scheduled, 2: sending, 3: paused, 4: stopped, 5: completed
	'status'       => 3, // pause this mailing
);
