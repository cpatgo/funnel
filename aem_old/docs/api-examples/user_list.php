<?php
/**
Title: View multiple (a list of) users.

Description: View many users with a single API call.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => user_list
	[*api_output] => xml, json, or serialize
	[*ids] => ID's (comma-separated) of each user you want to view
}
...
$params = array(
	...
	// a comma-separated list of IDs of users you wish to fetch
	'ids'          => '1,2,3,4,5',
);
