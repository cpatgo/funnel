<?php
/**
Title: View a specific User Group.

Description: View just a single User Group details and settings.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => group_view
	[*api_output] => xml, json, or serialize
	[*id] => ID of the User Group you wish to view
}

Example response:
{
	[limit_mail] => Limitations for sending mail. Example: 0
	[limit_mail_type] => Timeframe for limited mail sending. Example: month
	[limit_subscriber] => Limitations to number of subscribers.
	[limit_list] => Limitations to number of lists.
	[limit_campaign] => Limitations to number of campaigns.
	[limit_campaign_type] => Timeframe for limited campaigns. Example: month
	[limit_attachment] => Limitations to number of attachments. Example: -1
	[limit_user] => Limitations to number of users. Example: 0
	[abuseratio] => 4
	[forcesenderinfo] => 0
  ...
  [pg_reports_trend] => Permission for viewing trend reports. Example: 1 = yes, 0 = no
	...
	[abuses_reported] => 0
	[emails_sent] => 0
	[abuseratio_current] => 0
	[abuseratio_overlimit] => 0
	[users] => Array
...
$params = array(
	...
	// ID of the group you wish to fetch
	'id'           => 1,
);
