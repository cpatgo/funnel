<?php
/**
Title: Delete existing subscriber custom field.

Description: Allows you to delete an existing subscriber custom field.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => list_field_delete
	[*api_output] => xml, json, or serialize
	[*id] => ID of the subscriber custom field you wish to delete
}

Example response:
{
  [fieldid] => ID of the field just edited. Example: 1
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Custom Field deleted
...
$params = array(
	...
	// this is the action that deletes a list based on the ID you provide
	'api_action'   => 'list_field_delete',
	...
	// ID of the subscriber field you wish to delete
	'id'           => 6,
);
