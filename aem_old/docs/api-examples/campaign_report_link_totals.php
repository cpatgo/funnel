<?php
/**
Title: Obtain link click totals for a specific campaign.

Description: Obtain a total of all links clicked for a specific campaign. This only returns the total amount of links clicked, much like is seen along the top on the Campaign Reports page. To view individual links clicked, use campaign_report_link_list.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_link_totals
	[*api_output] => xml, json, or serialize
	[*campaignid] => ID of the campaign you wish to see forwards for
	[*messageid] => Message ID
}

Example response:
{
	[total_amt] => Total number of subscribers that were sent this campaign. Example: 4
	[linkclicks] => Total number of link clicks for this campaign. Example: 4
	[uniquelinkclicks] => Total number of unique link clicks for this campaign. Example: 4
	[avgclicks] => Average number of clicks amongst all subscribers. Example: 4.0000
	[didntclick] => Total number of subscribers that have not clicked any links. Example: 3
