<?php
/**
Title: Add new subscriber custom field.

Description: Add a new subscriber custom field, just like you would on the Custom Fields page of the admin section.
...
Example response:
{
	[fieldid] => ID of the field just added. Example: 2
	[result_code] => Whether or not the response was successful. Examples: 1 = yes, 0 = no
	[result_message] => A custom message that appears explaining what happened. Example: Custom Field added
