(function () {
	...
	$('body').find('#elementCats').after('<h3 style="margin-top:30px;"><span class="fui-document"></span> Templates</h3><ul id="elementCats" styles="margin-bottom: 30px;"><li><a href="#" id="travel">Travel</a></li></ul>');
