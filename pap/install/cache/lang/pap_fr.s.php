...
'Rewind unsupported in this file stream'=>'Rebobinage non soutenu dans ce jet de dossier',
...
'Within a few minutes you will receive instructions on how to reset your password.'=>'Vous allez recevoir un mail avec les instructions pour remettre à zéro votre mot de passe',
...
'There are missing From and To dates for \'Active in date range\' campaign validity'=>'Il manque De et \'Active in date range\' pour la validite de la campagne',
...
'Original currency rate'=>'Taux de change de devise',
...
'Payout information email'=>'Mail d\'information du paiement',
...
'Will be done later'=>'Sera fait plus tard',
...
'Add / edit DirectLink URL'=>'Ajouter / Editer une URL SEO',
...
'You are going to update'=>'mettre à jour',
...
'Screen %s is in menu and thus can not be deleted'=>'L\'écran %s est dans le menu et ne peut pas être supprimé ainsi',
...
'Required plugin %s is not active'=>'%s plugin exigé n\'est pas en activité',
'Required plugin %s has to be in version %s or higher'=>'%s plugin exigé doit être dans la version %s ou plus haut',
...
'Affiliate Login Link (html tag)'=>'Lien de connexion pour les affiliés',
'Merchant Login Url'=>'URL de connexion pour les annonceurs',
'Merchant Login Link (html tag)'=>'Lien de connexion pour les annonceurs',
