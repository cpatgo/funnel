...
'Within a few minutes you will receive instructions on how to reset your password.'=>'您將在幾分鐘內收到附有詳細說明如何重置您的密碼的電子郵件。',
...
'Add / edit DirectLink URL'=>'增加或編輯直接連接網址',
...
'Affiliate Login Link (html tag)'=>'加盟登錄連結',
'Merchant Login Url'=>'商家登陸網址',
'Merchant Login Link (html tag)'=>'商家登陸連結',
'Merchant login'=>'商家註冊',
...
'Must be bigger then "Ip address validity" defined below.'=>'必須大於 "Ip位址有效"',
...
'Private campaigns (separated by a comma)'=>'個人廣告方案 (用逗號分開)',
'Private campaigns\' IDs (separated by a comma) into which will be affiliate sign up after his signup.'=>'個人註冊的私人廣告方案的IDs (用逗號分開) 將會成為聯盟會員的註冊IDs。',
