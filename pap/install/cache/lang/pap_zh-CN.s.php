...
'Within a few minutes you will receive instructions on how to reset your password.'=>'您将在几分钟内收到附有详细说明如何重置您的密码的电子邮件。',
...
'Add / edit DirectLink URL'=>'增加或编辑直接连接网址',
...
'Affiliate Login Link (html tag)'=>'加盟登录链接',
'Merchant Login Url'=>'商家登陆网址',
'Merchant Login Link (html tag)'=>'商家登陆链接',
'Merchant login'=>'商家注册',
...
'Private campaigns (separated by a comma)'=>'个人广告方案 (用逗号分开)',
'Private campaigns\' IDs (separated by a comma) into which will be affiliate sign up after his signup.'=>'个人注册的私人广告方案的IDs (用逗号分开) 将会成为联盟会员的注册IDs。',
...
'Bluepay'=>'Bluepay',
'This plugin handles BluePay integration with Post Affiliate Pro'=>'该插件处理 BluePay 和 Post Affiliate Pro的整合',
...
'Display maximally 200 affiliates for each node.'=>'每个节点最多显示200个同盟会员',
