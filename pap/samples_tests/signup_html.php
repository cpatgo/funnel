...
<div class="c1_MainBox c1_SamplesMainbox">
	<div class="c1_MainBoxContainer">
		<h1>HTML Signup form</h1>
		<p>PAP has a standard signup form <a href="../affiliates/signup.php">here</a>, but it allows you to make your own signup form in HTML and place it anywhere you want.</p>
...
<?php if(isset($_POST)&&(!empty($_POST))) { ?>
    ...
    <h3>POST returned this data</h3><p>
<?php
...
<fieldset>
  ...
  <h3>HTML source code for this signup form</h3>
<pre>
&lt;form action="<?php echo $urlPart?>/affiliates/signup.php" method="post"&gt;
&lt;fieldset&gt;
    &lt;legend&gt;Personal Info&lt;/legend&gt;
    &lt;table cellpadding="3"&gt;
      &lt;tr&gt;&lt;td width="150px"&gt;&lt;strong&gt;Username (Email)&lt;/strong&gt;&lt;/td&gt;&lt;td&gt;&lt;input type="text" name="username"&gt;&lt;/td&gt;&lt;/tr&gt;
...
&lt;fieldset style="text-align: center"&gt;
    ...
    &lt;input type="submit" value="Signup"&gt;
    &lt;input type="hidden" name="errorUrl" value="<?php echo $urlPart?>/html_signup_form.php"&gt;
    &lt;input type="hidden" name="successUrl" value="<?php echo $urlPart?>/after_signup.php"&gt;
...
<div class="c1_WideSampleBox">
	<h2>Documentation</h2>
<p>The HTML signup form must be sent to /affiliates/signup.php after signup. Then there are two modes of operations.
If you don't include the <strong>errorUrl</strong>,<strong>successUrl</strong> hidden fields, the form will be processed by standard signup form.</p>
<p>
