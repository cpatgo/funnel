...
<div class="c1_MainBox c1_SamplesMainbox">
	<div class="c1_MainBoxContainer">
		<h1>Sale / lead / action tracking parameters</h1>
		<p>in your sale tracking code you can use various parameters that wil pass additional data about the transaction. </p>
...
<div class="c1_WideSampleBox">
	<h2>All possible tracking parameters</h2>
...
&lt;/script&gt;
		...
		<tr><td class="label">setBannerID()</td><td class="space">&nbsp;</td>
		    <td>ID of the banner. With this parameter you can force to register commission using this banner, also is applied campaign to which banner belongs.</td></tr>
		...
		<tr><td class="label">setCustomCommission()</td><td class="space">&nbsp;</td>
		    <td>value of custom commissions. You can force to use this commissions value instead of commissions set in campaign. If you put % in front of the number, the commission will be computed as percentage, for tiers separator use ';' e.g.: 10;5;3;1</td></tr>

		<tr><td class="label">setCustomCommissionNextTiersFromCampaign('Y')</td><td class="space">&nbsp;</td>
		    <td>use this if you want to generate other default tiers by campaign settings, without this is generated only custom commission tiers</td></tr>
		...
		<tr><td class="label">PostAffTracker.setAccountId('account_id')</td><td class="space">&nbsp;</td>
		    <td>use this line for Post Affiliate Network, set here your account Id instead of 'account_id'. Network owner can find it in Accounts > Account manager</td></tr>
		...
		<tr>
			<td class="label">PostAffTracker.register()</td><td class="space">&nbsp;</td>
...
<p>It will save commission with no other parameters. Makes sense only for fixed (not percentage) commissions. Also, you have to enable "saving commission for zero total cost".</p>
...
<p>It will save per action commission with code 'signup'.</p>
...
<p>You can use this code if you want to save commissions separately for different items in your shopping cart.</p>
...
<p>This will save a commission to the affiliate with ID or Referrer ID = testaff, doesn't matter who really referred the sale / lead.</p>
<pre>
&lt;script id="pap_x2s6df8d" src="<?php echo $urlPart?>/scripts/trackjs.js" type="text/javascript"&gt;
&lt;/script&gt;
&lt;script type="text/javascript"&gt;
...
<p>You can use this functionality to get the ID of affiliate who referred your customer, and then use it in your own script.
...
Link with added cookie info: <a href="<?php echo $urlPart?>/payment.php?amount=120&product=P1&order=123" id="affCookieLinkId">see destination url of this link</a><br />

Link with added affiliate id: <a href="<?php echo $urlPart?>/payment.php?amount=120&product=P1&order=123" id="affLinkId">see destination url of this link</a>
