 ...
 *   Generated on: 2016-07-06 06:57:00
 *   PAP version: 5.5.6.8, GPF version: 1.3.37.0
 *   
 */
  ...
  class Gpf_Data_RecordHeader extends Gpf_Object {
      ...
      public function add($id) {
          if (!is_numeric($id) && !is_string($id)) {
              $e = new Gpf_Exception('');
              Gpf_Log::error('Invalid type: \''.gettype($id).'\' of value: '.var_export($id, true).' for RecordHeader, trace: ' . $e->getTraceAsString());
              return;
          }
          if($this->contains($id)) {
              return;
  ...
  class Gpf_Data_IndexedRecordSet extends Gpf_Data_RecordSet {
      ...
      public function addRecord(Gpf_Data_Record $record) {
          ...
          if (!is_numeric($keyValue) && !is_string($keyValue)) {
              $e = new Gpf_Exception('');
              Gpf_Log::error('Invalid type: \''.gettype($keyValue).'\' of value: '.var_export($keyValue, true).' for RecordHeader, trace: ' . $e->getTraceAsString());
              return;
          }
...
/*
VERSION
11e96160ef51a43e87941df481ae9fdc
*/
?>