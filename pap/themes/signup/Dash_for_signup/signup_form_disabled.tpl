...
<div class="c1_MainBox c1_AffiliatesMainbox">
	<div class="c1_MainBoxContainer">
		...
		<p>Join our affiliate program and maximize your income with the global leader.
		</p>
	</div>
</div>
	...
	<div class="c1_WrapperContainer">
		<div class="c1_ContentLeft">
			...
			<div class="c1_ContentTextBlock">
				...
				<p><b>TODO: Describe affiliate program commission structure</b></p>
			</div>
			<div class="c1_ContentTextBlock">
				<h3>Payouts</h3>
				<p><b>TODO: Define custom conditions.</b><br/>
We pay our affiliates always on 15th day of the month for sales referred in last month. Minimum payout is $100 and you have to refer minimum two separated customers. Accepted are also self-purchases!
			...
			<h3>Frequently asked questions</h3>
				<h4>Can foreign affiliates apply?</h4>
				<p>All affiliates are welcome in our affiliate program.</p>
				<h4>Why should I become an affiliate?</h4>
		...
		<div class="c1_ContentRight">
		<p>##Signup form is disabled.##</p>
		</div>
