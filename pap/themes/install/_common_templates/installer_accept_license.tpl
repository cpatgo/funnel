...
{widget id="LicenseNumber" class="LicenseNumber1"}
<p>
##You can find the license ID in your member's panel. The license will be valid for the domain where you are currently installing the product.##
</p> 
<div class="Note">
...
{widget id="OfflineValidationButton"}
</div>
<div class="cleaner"></div>
</div>

<div class="FormFieldset">
    <div class="FormFieldsetHeaderTitle">##License agreement##</div>
...
<div class="AgreeLine">{widget id="LicenseAgreeInput" class="AgreeCheckBox Inliner"} 
{widget id="LicenseAgreeLabel"} {widget id="LicenseAgreeError"}</div>
<div class="cleaner"></div>
</div>
