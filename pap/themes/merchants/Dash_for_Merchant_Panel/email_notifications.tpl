...
{widget id="merchant_notification_email" class="MerchantNotificationEmail"}
...
<tr><td></td><td>{widget id="notif_disable_zero_comm_on_sale"}</td></tr>
<tr><td>{widget id="notification_on_extra_bonus"}</td><td></td></tr>
