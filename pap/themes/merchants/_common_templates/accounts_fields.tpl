...
<h3>##Available fields for account##</h3>
...
##The gray fields are fixed, and they are always present. You cannot configure them.<br/>You can use up to 25 custom fields to get the information from your network accounts. Just click on the name, type or status to change the field attributes.##
<br/>
<br/>
<div style="font-weight:bold; margin:0">
    <div class="FixedFieldCode">##Code##</div>
    <div class="FixedFieldName">##Name##</div>
    <div class="FixedFieldStatus">
        <div class="FloatLeft">##Status##</div>
        <div class="FloatLeft">{widget id="statusInfo"}</div>
    </div>
    <div class="FixedFieldType">##Type##</div>
    <div class="clear"></div>
</div>
