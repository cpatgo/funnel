...
<fieldset>
    <legend>##CallBack tracking (server side)##</legend>
...
<fieldset>
    <legend>##Statistics data##</legend>
    {widget id="salesStatsProcessorInterval" class="StatsProcessorInterval"}
    {widget id="impressions_clicks_hours_stats_max_days" class="StatsProcessorInterval"}
    <div class="clear"></div>
</fieldset>

<fieldset>
    <legend>##Tracking levels##</legend>
