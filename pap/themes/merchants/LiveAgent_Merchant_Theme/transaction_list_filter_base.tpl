...
<div class="TransactionsFilter">
	...
	<div class="FilterRow">
		<div class="FilterLegend">##Order ID##</div>
       		{widget id="orderId"}
		##You can input multiple order IDs separated either by new line or comma, use '%' for like search##
		<div class="clear"></div>
	</div>
	...
	<div class="FilterRow">
		<div class="FilterLegend">##Type##</div>
		{widget id="rtype"}
		<div class="clear"></div>
	</div>

	<div class="FilterRow">
        <div class="FilterLegend">##Tracked by##</div>
        {widget id="trackmethod"}
        <div class="clear"></div>
    </div>

    <div class="FilterRow">
        <div class="FilterLegend">##Payout status##</div>
