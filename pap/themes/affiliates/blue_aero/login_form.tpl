<!-- login_form -->
<div class="LoginMain">
<a class="Logo" title="{$programName}" href="{$baseUrl}/">
	           <img src="{$programLogo}" class="LogoImage"></a>
	<div class="Window-active">
		...
		<div class="WindowLeft"><div class="WindowRight"><div class="WindowIn"><div class="WindowContent">
			{widget id="username"}
			{widget id="password"}
            {widget id="language" class="LanguageSelector"}
			<div class="CheckBoxContainer">{widget id="rememberMeInput"} {widget id="rememberMeLabel"}</div>
			<div class="clear"></div>
			{widget id="FormMessage"}
			<div class="clear"></div>
			{widget id="LoginButton"}
			{widget id="ForgottenPasswordLink"}
			<div class="LoginIn">{$papCopyrightText}</div>
			<div class="clear"></div>
