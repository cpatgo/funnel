<?php
$l = new Gpf_Lang_Language('en-US');
$l->setName('English');
$l->setEnglishName('English');
$l->setAuthor('Quality Unit');
$l->setVersion('5.5.5.2');
$l->setDateFormat('MM/d/yyyy');
$l->setTimeFormat('HH:mm:ss');
$l->setThousandsSeparator('');
$l->setDecimalSeparator('.');
$l->setTranslationPercentage('100');
$l->setTextDirection('L');
...
'Failed to load direct link. (direct link probably deleted)'=>'Failed to load direct link. (direct link probably deleted)',
'Separator:'=>'Separator:',
...
'Sales and Actions count'=>'Sales and Actions count',
'No file uploaded'=>'No file uploaded',
'Transactions count'=>'Transactions count',
'PayoutOptionId is empty for userId: %s'=>'PayoutOptionId is empty for userId: %s',
'Unable to load Payout Option with Id: %s'=>'Unable to load Payout Option with Id: %s',
'Unable to load Payout Option field for: \'%s\' and field code: \'%s\''=>'Unable to load Payout Option field for: \'%s\' and field code: \'%s\'',
'Could not open csv file.'=>'Could not open csv file.',
'Failed to import language (%s)'=>'Failed to import language (%s)',
'%s (%s) language imported successfully.'=>'%s (%s) language imported successfully.',
'Language import successful.'=>'Language import successful.',
'In progress. Rows imported %s'=>'In progress. Rows imported %s',
'Importing language translations.'=>'Importing language translations.',
'In progress. Rows imported: %s'=>'In progress. Rows imported: %s',
'Migrate custom languages from csv files to database'=>'Migrate custom languages from csv files to database',
'Migrating translations from csv to database from language %s'=>'Migrating translations from csv to database from language %s',
'Removing cache file.'=>'Removing cache file.',
'Language %s csv file is missing from install directory.'=>'Language %s csv file is missing from install directory.',
'value of click commissions (at any tier)'=>'value of click commissions (at any tier)',
'Error, check your import file.'=>'Error, check your import file.',
'Unable to find header or data for this module.'=>'Unable to find header or data for this module.',
...
'Replication site Url'=>'Replication site Url',
'Merchant - On replication site stopped'=>'Merchant - On replication site stopped',
'Replication site stopped'=>'Replication site stopped',
'Error while loading replicated site: '=>'Error while loading replicated site: ',
'Problem loading replicated site.'=>'Problem loading replicated site.',
'Payout Option ID'=>'Payout Option ID',
'Database DEFAULT_CHARACTER_SET is \'%s\', please change it to \'%s\''=>'Database DEFAULT_CHARACTER_SET is \'%s\', please change it to \'%s\'',
'Database DEFAULT_COLLATION is \'%s\', please change it to \'%s\''=>'Database DEFAULT_COLLATION is \'%s\', please change it to \'%s\'',
'Maintenance Mode: Update in progress.'=>'Maintenance Mode: Update in progress.',
'An affiliate account will be created for each customer using order details from your Ecwid.'=>'An affiliate account will be created for each customer using order details from your Ecwid.',
'Approve affiliate'=>'Approve affiliate',
'If the payer is also an affiliate, their pending account will be approved automatically after successful payment.'=>'If the payer is also an affiliate, their pending account will be approved automatically after successful payment.',
'In case the payer is also an affiliate paying for their membership, their account will be declined if the membership is cancelled.'=>'In case the payer is also an affiliate paying for their membership, their account will be declined if the membership is cancelled.',
'Per product'=>'Per product',
'A commission will be created for each product of the order.'=>'A commission will be created for each product of the order.',
'Coupon tracking'=>'Coupon tracking',
'A coupon will be used for an affiliate identification.'=>'A coupon will be used for an affiliate identification.',
'You have to authorize the plugin with your Ecwid store first - please navigate to More Info section of the plugin.'=>'You have to authorize the plugin with your Ecwid store first - please navigate to More Info section of the plugin.',
'EcwidAPI settings saved'=>'EcwidAPI settings saved',
'Ecwid API and notification handling'=>'Ecwid API and notification handling',
'This plugin handles Ecwid notifications and integrates with Ecwid API (integration of Post Affiliate Pro with Ecwid).<br /><strong>To be able to use Ecwid API, you have to use a paid Ecwid license</strong>.'=>'This plugin handles Ecwid notifications and integrates with Ecwid API (integration of Post Affiliate Pro with Ecwid).<br /><strong>To be able to use Ecwid API, you have to use a paid Ecwid license</strong>.',
'Confirming the use of API with Ecwid:'=>'Confirming the use of API with Ecwid:',
'Your 1ShoppingCart merchant ID, found in your cart admin panel.'=>'Your 1ShoppingCart merchant ID, found in your cart admin panel.',
'Merchant API Key'=>'Merchant API Key',
'To find your merchant API key, navigate to your 1ShoppingCart admin panel My Account> API> API Settings'=>'To find your merchant API key, navigate to your 1ShoppingCart admin panel My Account> API> API Settings',
'1ShoppingCart settings saved'=>'1ShoppingCart settings saved',
'1ShoppingCart'=>'1ShoppingCart',
'This plugin handles 1ShoppingCart API notifications (integration of Post Affiliate Pro with 1ShoppingCart)'=>'This plugin handles 1ShoppingCart API notifications (integration of Post Affiliate Pro with 1ShoppingCart)',
'Replicated site banner'=>'Replicated site banner',
'was stopped, because of the multiple problems accessing url for this site'=>'was stopped, because of the multiple problems accessing url for this site',
'Not working url:'=>'Not working url:',
'User \'%s\' is declined for this campaign.'=>'User \'%s\' is declined for this campaign.',
'Page with this url already exists'=>'Page with this url already exists',
'Please check it you are able to connect %s from this server.'=>'Please check it you are able to connect %s from this server.',
'Failed to load task.'=>'Failed to load task.',
'Task is running.'=>'Task is running.',
'Failed to execute task.'=>'Failed to execute task.',
'Task processed.'=>'Task processed.',
'One step processed.'=>'One step processed.',
'Error while running task: '=>'Error while running task: ',
'HTML code'=>'HTML code',
'Banner parameters'=>'Banner parameters',
'Variable comments are not correctly enclosed. Correct or remove them. Variable comment looks like: "{*First Name*}"'=>'Variable comments are not correctly enclosed. Correct or remove them. Variable comment looks like: "{*First Name*}"',
'Save your previously added currency before adding another one.'=>'Save your previously added currency before adding another one.',
'Hosting update'=>'Hosting update',
'Campaign Status'=>'Campaign Status',
'Affiliate - On campaign status changed'=>'Affiliate - On campaign status changed',
'is changed to'=>'is changed to',
'Campaign status Change Mail Task'=>'Campaign status Change Mail Task',
'Unsubscribe link'=>'Unsubscribe link',
'Default campaign is stopped/paused. Also tracking of general affiliate link is stopped.'=>'Default campaign is stopped/paused. Also tracking of general affiliate link is stopped.',
' as default currency'=>' as default currency',
'Currency code(s) already exists: '=>'Currency code(s) already exists: ',
'Built in template can not be reverted'=>'Built in template can not be reverted',
'Error saving file %s '=>'Error saving file %s ',
'Copy custom templates to db.'=>'Copy custom templates to db.',
'Failed to save field(s) in %s(s)'=>'Failed to save field(s) in %s(s)',
'Field(s) in %s(s) successfully saved'=>'Field(s) in %s(s) successfully saved',
'Export file doesn\'t exist.'=>'Export file doesn\'t exist.',
'Same filename for his theme already exists.'=>'Same filename for his theme already exists.',
'Theme file (theme.php) does not exist for theme %s'=>'Theme file (theme.php) does not exist for theme %s',
'in database'=>'in database',
'1. Product IDs'=>'1. Product IDs',
'Set product ID which is supposed to move affiliates (customers) to a group choosen in "1. Commission Group". You can set more products comma separated. E.g.: product1,product2'=>'Set product ID which is supposed to move affiliates (customers) to a group choosen in "1. Commission Group". You can set more products comma separated. E.g.: product1,product2',
'1. Commission Group'=>'1. Commission Group',
'2. Product IDs'=>'2. Product IDs',
'Set product ID which is supposed to move affiliates (customers) to a group choosen in "2. Commission Group". You can set more products comma separated. E.g.: product1,product2'=>'Set product ID which is supposed to move affiliates (customers) to a group choosen in "2. Commission Group". You can set more products comma separated. E.g.: product1,product2',
'2. Commission Group'=>'2. Commission Group',
'3. Product IDs'=>'3. Product IDs',
'Set product ID which is supposed to move affiliates (customers) to a group choosen in "3. Commission Group". You can set more products comma separated. E.g.: product1,product2'=>'Set product ID which is supposed to move affiliates (customers) to a group choosen in "3. Commission Group". You can set more products comma separated. E.g.: product1,product2',
'3. Commission Group'=>'3. Commission Group',
'4. Product IDs'=>'4. Product IDs',
'Set product ID which is supposed to move affiliates (customers) to a group choosen in "4. Commission Group". You can set more products comma separated. E.g.: product1,product2'=>'Set product ID which is supposed to move affiliates (customers) to a group choosen in "4. Commission Group". You can set more products comma separated. E.g.: product1,product2',
'4. Commission Group'=>'4. Commission Group',
'5. Product IDs'=>'5. Product IDs',
'Set product ID which is supposed to move affiliates (customers) to a group choosen in "5. Commission Group". You can set more products comma separated. E.g.: product1,product2'=>'Set product ID which is supposed to move affiliates (customers) to a group choosen in "5. Commission Group". You can set more products comma separated. E.g.: product1,product2',
'5. Commission Group'=>'5. Commission Group',
'Extra Data'=>'Extra Data',
'Which extra data is used for customer/affiliate email. Default data field is 1.'=>'Which extra data is used for customer/affiliate email. Default data field is 1.',
'Assign to groups by ordered products'=>'Assign to groups by ordered products',
'This plugin will place an affiliate/customer to a specific commission group in a campaign, based on the product they order.'=>'This plugin will place an affiliate/customer to a specific commission group in a campaign, based on the product they order.',
'Track \'Charge\' event'=>'Track \'Charge\' event',
'By default, the plugin tracks commissions when \'invoice.payment_succeeded\' event is received. The checkbox will make the plugin to listen to \'charge.succeeded\' which is useful when you (your site/plugin) do not use invoices.'=>'By default, the plugin tracks commissions when \'invoice.payment_succeeded\' event is received. The checkbox will make the plugin to listen to \'charge.succeeded\' which is useful when you (your site/plugin) do not use invoices.',
'Status of camapaign'=>'Status of camapaign',
'was changed to'=>'was changed to',
'Add affiliate to campaign'=>'Add affiliate to campaign',
...
'In %s days since affiliate approval'=>'In %s days since affiliate approval',
'SCR unique'=>'SCR unique',
'.htaccess file in root directory of your %s installation is not working properly.'=>'.htaccess file in root directory of your %s installation is not working properly.',
'Redirect for images sucessfull'=>'Redirect for images sucessfull',
'Account name must be unique!'=>'Account name must be unique!',
'Unable to connect to email server, please correct your SMTP settings.'=>'Unable to connect to email server, please correct your SMTP settings.',
'Error during copy of sample image %s.'=>'Error during copy of sample image %s.',
'Display affiliate name'=>'Display affiliate name',
'Enables displaying of affiliate name.'=>'Enables displaying of affiliate name.',
'Display affiliate email'=>'Display affiliate email',
'Enables displaying of affiliate email.'=>'Enables displaying of affiliate email.',
'Display affiliate photo'=>'Display affiliate photo',
'Enables displaying of affiliate photo.'=>'Enables displaying of affiliate photo.',
'Field 1'=>'Field 1',
'When you choose a value here, it will enable displaying of the selected affiliate data field.'=>'When you choose a value here, it will enable displaying of the selected affiliate data field.',
'Field 2'=>'Field 2',
'Field 3'=>'Field 3',
'Field 4'=>'Field 4',
'Field 5'=>'Field 5',
'unused'=>'unused',
'AffiliateInfo settings saved'=>'AffiliateInfo settings saved',
'Affiliate info in external page'=>'Affiliate info in external page',
'This plugin enables you to display affiliate details in any page. You can load affiliate name, email and data fields defined by you in the plugin configuration. Read more in help section of this plugin. %sNote: allow affiliate fields carefully, anybody can access these details%s'=>'This plugin enables you to display affiliate details in any page. You can load affiliate name, email and data fields defined by you in the plugin configuration. Read more in help section of this plugin. %sNote: allow affiliate fields carefully, anybody can access these details%s',
'To get affiliate info, simply use the following code in your page, with the proper parameter:<br /><pre>'=>'To get affiliate info, simply use the following code in your page, with the proper parameter:<br /><pre>',
...
'You can input multiple order IDs separated either by new line or comma, use \'%\' for like search'=>'You can input multiple order IDs separated either by new line or comma, use \'%\' for like search',
'Number of Repeated Clicks'=>'Number of Repeated Clicks',
'Impressions repeated'=>'Impressions repeated',
'Clicks repeated'=>'Clicks repeated',
'CTR (Clickthrough ratio)'=>'CTR (Clickthrough ratio)',
'CTR repeated'=>'CTR repeated',
'Sale commissions'=>'Sale commissions',
'Click commissions'=>'Click commissions',
'SCR (Conversion ratio)'=>'SCR (Conversion ratio)',
'SCR repeated'=>'SCR repeated',
'Avg. com. per unique click'=>'Avg. com. per unique click',
'Duplicite commission type'=>'Duplicite commission type',
'Impressions (all / unique)'=>'Impressions (all / unique)',
'CTR (all / unique)'=>'CTR (all / unique)',
'Lightbox Banner'=>'Lightbox Banner',
'Enables lightbox (DIV on page) banner'=>'Enables lightbox (DIV on page) banner',
'Click here to see lightbox banner'=>'Click here to see lightbox banner',
'Form is not valid anymore, please refresh the page.'=>'Form is not valid anymore, please refresh the page.',
'Settings successfully saved.'=>'Settings successfully saved.',
'Recurring commission rules'=>'Recurring commission rules',
'Recurring commission rule'=>'Recurring commission rule',
'Status of selected recurring rule(s) was changed'=>'Status of selected recurring rule(s) was changed',
'Failed to change status of selected recurring rule(s)'=>'Failed to change status of selected recurring rule(s)',
'Clicks list'=>'Clicks list',
'Must be smaller then "Delete click records older than" defined in Tracking settings'=>'Must be smaller then "Delete click records older than" defined in Tracking settings',
'Repeated clicks'=>'Repeated clicks',
'Clicks older than %s are deleted'=>'Clicks older than %s are deleted',
'Failed to delete clicks'=>'Failed to delete clicks',
'Logins count'=>'Logins count',
'User settings'=>'User settings',
'All user settings'=>'All user settings',
'Sales Stats Processor User Task'=>'Sales Stats Processor User Task',
'Sales Stats Referrer Urls Processor'=>'Sales Stats Referrer Urls Processor',
'Invalid request, missing captcha field, please refresh your page'=>'Invalid request, missing captcha field, please refresh your page',
'Installation Url'=>'Installation Url',
'Installation Link'=>'Installation Link',
'On Invalid License'=>'On Invalid License',
'Invalid License'=>'Invalid License',
'This plugin forbids saving click data1/2 values to click stats which makes the click tables smaller but you won\'t be able to filter clicks by data1/2. Data1/2 will be available in Clicks list grid only.'=>'This plugin forbids saving click data1/2 values to click stats which makes the click tables smaller but you won\'t be able to filter clicks by data1/2. Data1/2 will be available in Clicks list grid only.',
...
'Clicks - Repeated'=>'Clicks - Repeated',
'OptimizeMember settings saved'=>'OptimizeMember settings saved',
'OptimizeMember notification handling'=>'OptimizeMember notification handling',
'This plugin handles notifications from your OptimizeMember WordPress plugin. Needs further configuration in your WordPress, please see the integration guide for OptimizeMember found in the Sale Tracking Integration section of your merchant panel.'=>'This plugin handles notifications from your OptimizeMember WordPress plugin. Needs further configuration in your WordPress, please see the integration guide for OptimizeMember found in the Sale Tracking Integration section of your merchant panel.',
'Repeated'=>'Repeated',
'Conversion ratio (all/repeated/unique)'=>'Conversion ratio (all/repeated/unique)',
'Avg. commission per click (all/repeated/unique)'=>'Avg. commission per click (all/repeated/unique)',
'Avg. commission per impression (all/repeated/unique)'=>'Avg. commission per impression (all/repeated/unique)',
'impressions repeated'=>'impressions repeated',
'clicks repeated'=>'clicks repeated',
'Last login:'=>'Last login:',
'Logins count:'=>'Logins count:',
'Google reCaptcha settings'=>'Google reCaptcha settings',
'Signup settings'=>'Signup settings',
'Request new password settings'=>'Request new password settings',
'compute values from all campaigns'=>'compute values from all campaigns',
'Delete click records older than'=>'Delete click records older than',
'clicks (repeated/unique) and'=>'clicks (repeated/unique) and',
'Contact Us forms'=>'Contact Us forms',
'Your license is invalid or expired:'=>'Your license is invalid or expired:',
'Please check your installation:'=>'Please check your installation:',
'Unable to check functionality of htaccess file. Contact our support.'=>'Unable to check functionality of htaccess file. Contact our support.',
'User Referral ID'=>'User Referral ID',
'HTML5 storage'=>'HTML5 storage',
'Automatic affiliate activity checking task'=>'Automatic affiliate activity checking task',
'Automatic affiliate activity checking'=>'Automatic affiliate activity checking',
'Afiliates settings saved'=>'Afiliates settings saved',
'Copyright text contains incorrect link html tag'=>'Copyright text contains incorrect link html tag',
'Pinterest Connect'=>'Pinterest Connect',
'Connect your affiliate program with Pinterest. Help your affiliates to share banners on Pinterest with friends.'=>'Connect your affiliate program with Pinterest. Help your affiliates to share banners on Pinterest with friends.',
'Deeplink generator'=>'Deeplink generator',
'Action for inactive affiliate'=>'Action for inactive affiliate',
'Number of days that affiliate was inactive'=>'Number of days that affiliate was inactive',
'removed'=>'removed',
'Affiliate - Inactivity action'=>'Affiliate - Inactivity action',
'Inactivity'=>'Inactivity',
'Remain days for action'=>'Remain days for action',
'Affiliate - Inactivity warning'=>'Affiliate - Inactivity warning',
'Inactivity warning'=>'Inactivity warning',
'Affiliate - New Extra Bonus Commission'=>'Affiliate - New Extra Bonus Commission',
'New extra bonus commission'=>'New extra bonus commission',
'Merchant - On extra bonus'=>'Merchant - On extra bonus',
'New extra bonus'=>'New extra bonus',
'No file uploaded.'=>'No file uploaded.',
'Error import theme: File does not exists!'=>'Error import theme: File does not exists!',
'Incorrect theme zip file: missing theme.php!'=>'Incorrect theme zip file: missing theme.php!',
'Theme successfully imported with name: %s'=>'Theme successfully imported with name: %s',
'Top Campaigns'=>'Top Campaigns',
'You don\'t have permissions.'=>'You don\'t have permissions.',
'%s transaction(s) was updated, %s transaction(s) was skipped, because you don\'t have permissions.'=>'%s transaction(s) was updated, %s transaction(s) was skipped, because you don\'t have permissions.',
'%s transaction(s) was skipped, because you don\'t have permissions.'=>'%s transaction(s) was skipped, because you don\'t have permissions.',
'Status of %s transaction(s) for orderid %s was changed'=>'Status of %s transaction(s) for orderid %s was changed',
'Row skipped: '=>'Row skipped: ',
'Impression/ click'=>'Impression/ click',
'Click/ transaction'=>'Click/ transaction',
'Impression/ transaction'=>'Impression/ transaction',
'Processing %s, progress: %s'=>'Processing %s, progress: %s',
'Maximum failed locks count %s reached. Giving up.'=>'Maximum failed locks count %s reached. Giving up.',
'Database DEFAULT_CHARACTER_SET is correct'=>'Database DEFAULT_CHARACTER_SET is correct',
'Database DEFAULT_CHARACTER_SET is incorrect'=>'Database DEFAULT_CHARACTER_SET is incorrect',
'Please set DEFAULT_CHARACTER_SET to "%s"'=>'Please set DEFAULT_CHARACTER_SET to "%s"',
'Database DEFAULT_COLLATION is correct'=>'Database DEFAULT_COLLATION is correct',
'Database DEFAULT_COLLATION is incorrect'=>'Database DEFAULT_COLLATION is incorrect',
'Please set DEFAULT_COLLATION to "%s"'=>'Please set DEFAULT_COLLATION to "%s"',
'you were inactive in our affiliate program for'=>'you were inactive in our affiliate program for',
'days, therefore you are '=>'days, therefore you are ',
'from our affiliate program'=>'from our affiliate program',
'days, if you will not make any activity soon, you will be'=>'days, if you will not make any activity soon, you will be',
'from our affiliate program in'=>'from our affiliate program in',
'you got Extra Bonus commission'=>'you got Extra Bonus commission',
'Commission for this bonus'=>'Commission for this bonus',
'A new extra bonus was recorded at '=>'A new extra bonus was recorded at ',
'Import theme'=>'Import theme',
'Import zip file, zip file of custom theme can be created via theme editor.'=>'Import zip file, zip file of custom theme can be created via theme editor.',
'Does not affect Last login date and Logins count'=>'Does not affect Last login date and Logins count',
'Statistics payout status'=>'Statistics payout status',
'Cities field is mandatory!'=>'Cities field is mandatory!',
'Visitor Affiliate'=>'Visitor Affiliate',
'Hash script file names (hashed scripts are hard to be blocked by AdBlock), mod_rewrite rules are used, defined in .htaccess file.'=>'Hash script file names (hashed scripts are hard to be blocked by AdBlock), mod_rewrite rules are used, defined in .htaccess file.',
'Payout method is not set, please setup payout method in your payment details.'=>'Payout method is not set, please setup payout method in your payment details.',
'count of all sub-affiliates'=>'count of all sub-affiliates',
'count of visible sub-affiliates'=>'count of visible sub-affiliates',
'Automatic affiliate activity checking feature allows you to automatically check for inactive affiliates, send email notifications to them and automatically decline or delete inactive affiliate accounts. Activating this feature adds a new option item "Affiliates activity check" to merchant panel configuration menu. This feature requires Cron job to work.'=>'Automatic affiliate activity checking feature allows you to automatically check for inactive affiliates, send email notifications to them and automatically decline or delete inactive affiliate accounts. Activating this feature adds a new option item "Affiliates activity check" to merchant panel configuration menu. This feature requires Cron job to work.',
'Automatic affiliate activity checking require cron job which is not running now. Please set it up in Tools -> Integration -> Cron Job Integration'=>'Automatic affiliate activity checking require cron job which is not running now. Please set it up in Tools -> Integration -> Cron Job Integration',
'Lifetime referrals manager'=>'Lifetime referrals manager',
'This feature allows you to manage lifetime relations between your affiliates and customers created by our Lifetime Commissions plugin directly in your merchant panel interface. Activating this feature adds new menu item "Lifetime referrals" into affiliate menu in your merchant panel.'=>'This feature allows you to manage lifetime relations between your affiliates and customers created by our Lifetime Commissions plugin directly in your merchant panel interface. Activating this feature adds new menu item "Lifetime referrals" into affiliate menu in your merchant panel.',
'Identifier'=>'Identifier',
'Lifetime referrals'=>'Lifetime referrals',
'status as current group'=>'status as current group',
'No file after clone of rebrand banner.'=>'No file after clone of rebrand banner.',
'.htaccess RewriteRule rules are not working. Configuration depends on your server, read more in our knowledgebase: %s'=>'.htaccess RewriteRule rules are not working. Configuration depends on your server, read more in our knowledgebase: %s',
'No custom translations are selected.'=>'No custom translations are selected.',
'Include affiliate referral id into custom data fields'=>'Include affiliate referral id into custom data fields',
'If is checked, referral id will be added into customs fields as \'referralid\'.'=>'If is checked, referral id will be added into customs fields as \'referralid\'.',
'Include affiliate password into custom data fields'=>'Include affiliate password into custom data fields',
'If is checked, password will be added into customs fields as \'affpassword\'.'=>'If is checked, password will be added into customs fields as \'affpassword\'.',
'Include affiliate parent user Id into custom data fields'=>'Include affiliate parent user Id into custom data fields',
'If is checked, parent user id will be added into customs fields as \'parentuserid\'.'=>'If is checked, parent user id will be added into customs fields as \'parentuserid\'.',
'Track coupons'=>'Track coupons',
'For coupon tracking, you have to set also 2CO API username and password.'=>'For coupon tracking, you have to set also 2CO API username and password.',
'API username'=>'API username',
'Your 2CO API username. <a href="https://www.2checkout.com/documentation/api/" target="_parent">More info</a>'=>'Your 2CO API username. <a href="https://www.2checkout.com/documentation/api/" target="_parent">More info</a>',
'API password'=>'API password',
'Your 2CO API password. <a href="https://www.2checkout.com/documentation/api/" target="_parent">More info</a>'=>'Your 2CO API password. <a href="https://www.2checkout.com/documentation/api/" target="_parent">More info</a>',
'You have to set your API credentials to track coupons!'=>'You have to set your API credentials to track coupons!',
'This plugin handles 2Checkout integration with Post Affiliate Pro'=>'This plugin handles 2Checkout integration with Post Affiliate Pro',
'Lifetime relation'=>'Lifetime relation',
'Delete of affiliate causes that all his statistics (clicks, commissions, payouts,...) will be deleted.'=>'Delete of affiliate causes that all his statistics (clicks, commissions, payouts,...) will be deleted.',
'If you want to keep affiliate\'s stats and details change affiliate status to declined instead of deleting him.'=>'If you want to keep affiliate\'s stats and details change affiliate status to declined instead of deleting him.',
'Data with value \''=>'Data with value \'',
'Channel name and code cannot be empty.'=>'Channel name and code cannot be empty.',
'% in total cost'=>'% in total cost',
'% of Sales count'=>'% of Sales count',
'% of Sales commissions'=>'% of Sales commissions',
'Recognize from coupon only affiliate'=>'Recognize from coupon only affiliate',
'If this is checked only affiliate is recognized from coupon, campaign and banner is recognized by common tracking processing.'=>'If this is checked only affiliate is recognized from coupon, campaign and banner is recognized by common tracking processing.',
'Use default campaign from coupon'=>'Use default campaign from coupon',
'If this is checked and campaign is not primary from coupon, but via tracking processing, as default campaign is used campaign from coupon.'=>'If this is checked and campaign is not primary from coupon, but via tracking processing, as default campaign is used campaign from coupon.',
'Global Rule'=>'Global Rule',
'Unable to save file, please use extension: %s'=>'Unable to save file, please use extension: %s',
'Group impressions after days'=>'Group impressions after days',
'Top Banners'=>'Top Banners',
'Sale requests log'=>'Sale requests log',
'Sale visit log delete task'=>'Sale visit log delete task',
'Sale log event'=>'Sale log event',
'You do not have privilages to delete Sale visit log: %s'=>'You do not have privilages to delete Sale visit log: %s',
'Failed to restart %s %s(s)'=>'Failed to restart %s %s(s)',
'%s %s(s) successfully restarted'=>'%s %s(s) successfully restarted',
'Visit date'=>'Visit date',
'Sale params'=>'Sale params',
'Track method'=>'Track method',
'Account Id'=>'Account Id',
'Visitor Id'=>'Visitor Id',
'Group Old Clicks Task'=>'Group Old Clicks Task',
'Group Old Impressions Task'=>'Group Old Impressions Task',
'Recognize account from'=>'Recognize account from',
'Latest click'=>'Latest click',
'First click'=>'First click',
'Network Account Auto Recognition'=>'Network Account Auto Recognition',
'Sale/action tracking processor will recognize network account ID automatically depends on banner (or campaign) from latest click. Plugin is applied only if you don\'t use function \'PostAffTracker.setAccountId(\'xxxxxxxx\');\' in your sale tracking code.'=>'Sale/action tracking processor will recognize network account ID automatically depends on banner (or campaign) from latest click. Plugin is applied only if you don\'t use function \'PostAffTracker.setAccountId(\'xxxxxxxx\');\' in your sale tracking code.',
'Enter your sercret word here, see integration steps for OptimizeMember.'=>'Enter your sercret word here, see integration steps for OptimizeMember.',
'When this is checked, the plugin will try to create an affiliate account based on information sent from OptimizeMember. Requires further setting up, see the integration method.'=>'When this is checked, the plugin will try to create an affiliate account based on information sent from OptimizeMember. Requires further setting up, see the integration method.',
'This plugin signs up affiliate to campaign after signup. Campaign ID must be passed in a_cid input field via custom HTML signup form. For signing up to multiple campaigns, use campaign IDs separated by comma. Example: &lt;input type="text" name="a_cid"&gt;'=>'This plugin signs up affiliate to campaign after signup. Campaign ID must be passed in a_cid input field via custom HTML signup form. For signing up to multiple campaigns, use campaign IDs separated by comma. Example: &lt;input type="text" name="a_cid"&gt;',
'Commission date'=>'Commission date',
'Demo affiliate can not be deleted'=>'Demo affiliate can not be deleted',
'This affiliate cannot be deleted, he is used for not referred commissions. Change this setting in Configuration > Tracking settings.'=>'This affiliate cannot be deleted, he is used for not referred commissions. Change this setting in Configuration > Tracking settings.',
'owner'=>'owner',
'Invalid txt dns record'=>'Invalid txt dns record',
'Invalid txt dns record (Invalid SPF)'=>'Invalid txt dns record (Invalid SPF)',
'Warning: More than 10 include mechanisms detected.'=>'Warning: More than 10 include mechanisms detected.',
'Warning: Multiple spf1 records detected.'=>'Warning: Multiple spf1 records detected.',
'Invalid txt dns record for email domain.'=>'Invalid txt dns record for email domain.',
'Could not resolve DNS record for domain'=>'Could not resolve DNS record for domain',
'Your NginX is not configured. Please check %s and configure your NginX'=>'Your NginX is not configured. Please check %s and configure your NginX',
'Your Windows IIS does not have configured required redirect rules. Please check %s and configure your Windows-IIS server.'=>'Your Windows IIS does not have configured required redirect rules. Please check %s and configure your Windows-IIS server.',
'List of recurring commissions'=>'List of recurring commissions',
'List of refunds'=>'List of refunds',
'List of chargebacks'=>'List of chargebacks',
'Number of Recurring commissions'=>'Number of Recurring commissions',
'Total cost of Recurring commissions'=>'Total cost of Recurring commissions',
'Comissions per Recurring commissions'=>'Comissions per Recurring commissions',
'Number of Refunds'=>'Number of Refunds',
'Total cost of Refunds'=>'Total cost of Refunds',
'Comissions per Refunds'=>'Comissions per Refunds',
'Banner code was confirmed'=>'Banner code was confirmed',
'Error occured on banner confirmation.'=>'Error occured on banner confirmation.',
'processed %s rows.'=>'processed %s rows.',
'It is not allowed to upload file bigger than %s MB. Your file has size %s MB.'=>'It is not allowed to upload file bigger than %s MB. Your file has size %s MB.',
'You can find your keys in your Braintree control panel, in Account> My user> API Keys, Tokenization Keys, Encryption Keys section'=>'You can find your keys in your Braintree control panel, in Account> My user> API Keys, Tokenization Keys, Encryption Keys section',
'Public Key'=>'Public Key',
'Private Key'=>'Private Key',
'Custom field name'=>'Custom field name',
'Set by the integration method - the first step. This is set to "visitorid" by default, so if you have to use something else for some reason, you can change it here.'=>'Set by the integration method - the first step. This is set to "visitorid" by default, so if you have to use something else for some reason, you can change it here.',
'Environment'=>'Environment',
'When enabled, the plugin will create an affiliate account automatically using payer details.'=>'When enabled, the plugin will create an affiliate account automatically using payer details.',
'Custom field name cannot be empty! You can use the default value "visitorid"'=>'Custom field name cannot be empty! You can use the default value "visitorid"',
'Braintree webhook handling'=>'Braintree webhook handling',
'This plugin handles Braintree webhooks'=>'This plugin handles Braintree webhooks',
'Only matched recurrence'=>'Only matched recurrence',
'If an initial payment was not tracked, a recurring commission will not be created as well. By disabling this option, you will be able to track such a recurring commission if it was referred.'=>'If an initial payment was not tracked, a recurring commission will not be created as well. By disabling this option, you will be able to track such a recurring commission if it was referred.',
'Tips and common practice you can do to increase the traffic and earn more commissions from our affiliate program.'=>'Tips and common practice you can do to increase the traffic and earn more commissions from our affiliate program.',
'Questions and answers about our affiliate program, the conditions, payouts, tracking, and much more.'=>'Questions and answers about our affiliate program, the conditions, payouts, tracking, and much more.',
'Possibilities of advanced tracking in our affiliate program - includes tracking od Advertisement channels and Sub Id tracking.'=>'Possibilities of advanced tracking in our affiliate program - includes tracking od Advertisement channels and Sub Id tracking.',
'DirectLink tracking explained'=>'DirectLink tracking explained',
'Explains how DirectLink tracking works and how you can use it.'=>'Explains how DirectLink tracking works and how you can use it.',
'Setup SPF record in your domain settings. You need it to be sure, that your replies won\'t be recognized as spam. Please add one of these two lines to TXT record of your domain. We recommend you to use:'=>'Setup SPF record in your domain settings. You need it to be sure, that your replies won\'t be recognized as spam. Please add one of these two lines to TXT record of your domain. We recommend you to use:',
'If you need multiple SPF mechanisms, you can also add include mechanism to your existing record.'=>'If you need multiple SPF mechanisms, you can also add include mechanism to your existing record.',
'Note: Be sure you have only one DNS record. For more information check our knowledge base:'=>'Note: Be sure you have only one DNS record. For more information check our knowledge base:',
'Currently active features'=>'Currently active features',
'Inactive features'=>'Inactive features',
