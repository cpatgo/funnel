...
smarty_core_load_plugins(array('plugins' => array(array('function', 'localize', 'account_form.tpl', 2, false),)), $this); ?>
<!-- account_form -->
<div class="FormFieldsetSectionTitle"><?php echo smarty_function_localize(array('str' => 'Account details'), $this);?>
</div>
  ...
  <?php echo "<div id=\"defaultCampaignPrivate\"></div>"; ?>
  <?php echo "<div id=\"prepaidAccount\"></div>"; ?>
  <div class="AccountFieldsLink">
      <?php echo "<div id=\"accountFieldsLink\"></div>"; ?>
  </div> 
