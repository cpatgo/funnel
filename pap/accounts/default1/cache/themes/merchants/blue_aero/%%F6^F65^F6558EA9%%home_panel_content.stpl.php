<?php /* Smarty version 2.6.18, created on 2016-07-06 14:15:34
         compiled from home_panel_content.stpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'localize', 'home_panel_content.stpl', 4, false),array('modifier', 'number_span', 'home_panel_content.stpl', 38, false),array('modifier', 'currency_span', 'home_panel_content.stpl', 76, false),)), $this); ?>
<!-- home_panel_content -->
...
<table width="600" class="StatsSummaries">
  <tr class="light">
    <td class="TextAlignLeft" width="20%" nowrap><a href="#Affiliate-Manager"><?php echo smarty_function_localize(array('str' => 'Affiliates'), $this);?>
</a></td>
    <td class="TextAlignRight"><span class="NumberData"><?php echo $this->_tpl_vars['pendingTasks']['affiliates']; ?>
</span></td>
    <td class="TextAlignLeft" width="20%" nowrap><a href="#Transaction-Manager"><?php echo smarty_function_localize(array('str' => 'Commissions'), $this);?>
</a></td>
    <td class="TextAlignRight"><span class="NumberData"><?php echo $this->_tpl_vars['pendingTasks']['commissions']; ?>
</span></td>
  </tr>
  <tr class="dark">
    <td class="TextAlignLeft" width="20%" nowrap><a href="#Direct-Links-Manager"><?php echo smarty_function_localize(array('str' => 'DirecLink Urls'), $this);?>
</a></td>
    <td class="TextAlignRight"><span class="NumberData"><?php echo $this->_tpl_vars['pendingTasks']['links']; ?>
</span></td>
    <td class="TextAlignLeft" width="20%" nowrap><a href="#Mail-Outbox"><?php echo smarty_function_localize(array('str' => 'Unsent emails'), $this);?>
</a></td>
    <td class="TextAlignRight"><span class="NumberData"><?php echo $this->_tpl_vars['pendingTasks']['emails']; ?>
</span></td>
  </tr>  
</table>
<br/><br/>
...
<table width="600" class="StatsSummaries">
  ...
  <tr class="light">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Impressions'), $this);?>
</td>
    ...
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['todayImpressions']->count->unique)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['todayImpressions']->count->all)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    ...
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['thisMonthImpressions']->count->unique)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['thisMonthImpressions']->count->all)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
  </tr>
  <tr class="dark">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Clicks'), $this);?>
</td>
    ...
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['todayClicks']->count->unique)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['todayClicks']->count->all)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    ...
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['thisMonthClicks']->count->unique)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
    <td align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['thisMonthClicks']->count->all)) ? $this->_run_mod_handler('number_span', true, $_tmp) : smarty_modifier_number_span($_tmp)); ?>
</td>
  </tr>
  ...
  <tr class="light">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Number of Sales'), $this);?>
</td>
  ...
  <tr class="dark">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Total cost of Sales'), $this);?>
</td>
  ...
  <?php if ($this->_tpl_vars['actionCommissionsEnabled'] == 'Y'): ?>
      <tr class="light">
        <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Number of Actions'), $this);?>
</td>
      ...
      <tr class="dark">
        <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'Total cost of Actions'), $this);?>
</td>
  ...
  <?php endif; ?>
  <tr class="light">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'All Commissions'), $this);?>
</td>
  ...
  <tr class="dark">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'All Refunds'), $this);?>
</td>
  ...
  <tr class="light">
    <td class="TextAlignLeft" width="30%" nowrap><?php echo smarty_function_localize(array('str' => 'All Chargebacks'), $this);?>
</td>
