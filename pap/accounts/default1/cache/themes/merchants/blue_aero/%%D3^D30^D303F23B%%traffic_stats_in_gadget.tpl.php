...
</td><td>&nbsp;&nbsp;</td><td nowrap class="TextAlignRight"><?php echo "<div id=\"countImpressions\"></div>"; ?></td>
</tr><tr>
  <td><?php echo smarty_function_localize(array('str' => 'Clicks'), $this);?>
</td><td>&nbsp;&nbsp;</td><td nowrap class="TextAlignRight"><?php echo "<div id=\"countClicks\"></div>"; ?></td>
</tr><tr>
  <td><?php echo smarty_function_localize(array('str' => ' # of Sales / Leads'), $this);?>
</td><td>&nbsp;&nbsp;</td><td nowrap class="TextAlignRight"><?php echo "<div id=\"countSales\"></div>"; ?></td>
</tr><tr>
  <td><?php echo smarty_function_localize(array('str' => 'Commissions'), $this);?>
</td><td>&nbsp;&nbsp;</td><td nowrap class="TextAlignRight"><?php echo "<div id=\"sumCommissions\"></div>"; ?></td>
</tr><tr>
  <td><?php echo smarty_function_localize(array('str' => 'Revenue'), $this);?>
</td><td>&nbsp;&nbsp;</td><td nowrap class="TextAlignRight"><?php echo "<div id=\"sumSales\"></div>"; ?></td>
</tr>
</table>