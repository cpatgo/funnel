...
<div class="PopupWinMain">
	...
	<tr>
	  ...
	  <td valign="top" class="TextAlignLeft" colspan="3"><?php echo smarty_function_localize(array('str' => 'File on the Internet (enter image URL)'), $this);?>
</td>
	</tr><tr>
	  <td valign="top" class="TextAlignLeft" ><?php echo "<div id=\"FileUrl\"></div>"; ?></td>
	  <td>&nbsp;</td>
