...
<!-- transaction_list_filter_base -->
			...
			<div class="TransactionsFilter">
            	...
            	<fieldset class="Filter FilterOrder">
            		...
            		<div class="FilterInfo"><?php echo smarty_function_localize(array('str' => 'You can input multiple order IDs separated either by new line or comma, use \'%\' for like search'), $this);?>
</div>
            		</fieldset>
                ...
                <fieldset class="Filter FilterType">
                    <legend><?php echo smarty_function_localize(array('str' => 'Tracked by'), $this);?>
</legend>
                    <div class="Resize">
                ...
                <fieldset class="Filter FilterType">
                    <legend><?php echo smarty_function_localize(array('str' => 'Payout status'), $this);?>
</legend>
                    <div class="Resize">
