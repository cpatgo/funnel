    ...
    <table>
        ...
        <tr>
            <td colspan="5">
                ...
                <legend><?php echo smarty_function_localize(array('str' => 'Optional'), $this);?>
</legend>
                <table>
                    <tr>
                        <td colspan="1"><?php echo smarty_function_localize(array('str' => 'And'), $this);?>
</td>
                        <td><?php echo "<div id=\"dataField\" class=\"ConditionListBox\"></div>"; ?></td>
                        <td><?php echo "<div id=\"dataFieldEquation\" class=\"ConditionListBox\"></div>"; ?></td>
                        <td><?php echo "<div id=\"dataFieldValue\"></div>"; ?></td>
                    </tr>
                </table>
                </fieldset>
            </td>
