...
smarty_core_load_plugins(array('plugins' => array(array('function', 'localize', 'rule_panel.tpl', 20, false),)), $this); ?>
<!--    rule_panel      -->
...
<fieldset>
    ...
    <table>
        <tr>
            ...
            <td width="205"><?php echo "<div id=\"action\" class=\"ConditionListBox\"></div>"; ?></td>
        ...
        <tr>
            <td><?php echo "<div id=\"commissiongroupstatusLabel\"></div>"; ?></td>
            <td><?php echo "<div id=\"commissiongroupstatus\" class=\"ConditionListBox\"></div>"; ?></td>
        </tr>
    </table>
</fieldset>
