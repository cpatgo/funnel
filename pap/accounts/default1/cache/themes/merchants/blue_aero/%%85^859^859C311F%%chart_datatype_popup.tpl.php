...
<div class="PopupWinMain">
	...
	<table border=0 cellspacing=0 cellpadding="3">
		<tr>
		  <td class="TextAlignLeft"><?php echo smarty_function_localize(array('str' => 'First data line'), $this);?>
</td><td><?php echo "<div id=\"DataType1\"></div>"; ?></td>
		</tr>
		<tr>
		  <td class="TextAlignLeft"><?php echo smarty_function_localize(array('str' => 'Second data line'), $this);?>
