...
class PayPal_Main extends Gpf_Plugins_Handler {
    ...
    public function initSettings($context) {
        ...
        $context->addDbSetting(PayPal_Config::RECURRING_TOTALCOST_FROM_NOTIFICATION, '');
        ...
        $context->addDbSetting(PayPal_Config::DECLINE_AFFILIATE, '');
        $context->addDbSetting(PayPal_Config::USE_LIFETIME, '');
