...
class AlertPay_Main extends Gpf_Plugins_Handler {
    ...
    public function initSettings(Gpf_Settings_Gpf $context) {
        ...
        $context->addDbSetting(AlertPay_Config::CREATE_AFFILIATE, Gpf::NO);
        $context->addDbSetting(AlertPay_Config::DECLINE_AFFILIATE, Gpf::NO);
        $context->addDbSetting(AlertPay_Config::ALLOW_TEST_SALES, Gpf::NO);
