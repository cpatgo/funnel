...
<?php if((int)$user_membership['id'] < 5): ?>    
    <input type="hidden" id="current_membership_amount" value="<?php echo $user_membership['amount'] ?>">
    <div style="background-color:#fff;">
        <div class="container-fluid">
                <form class="form-horizontal" id="upgrade_form_outside_backoffice_vip" accept-charset="utf-8">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div style="padding-top:10px">
                                            <b><?php echo $user_membership['membership'] ?><b>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        foreach ($membership as $key => $value) {
                                            if($value['membership'] === 'Free' || $value['membership'] === 'Executive' || $user_membership['initial'] >= $value['id'] || $value['membership'] === 'Leadership' || $value['membership'] === 'Professional') continue;
                                            printf('<div class="radio i-checks"><label><input type="radio" class="form-control" value="%d" name="upgrade_membership" %s data-amt=%d> <i></i> %s %s</label></div>', 
                                                $value['id'], 
                                                ((int)$value['id'] === 6) ? 'checked="checked"' : '', 
                                                $value['amount'],
                                                $value['membership'],
                                                ((int)$value['id'] === 6) ? sprintf('<span id="amount_text" class="alert-danger" style="padding:5px;"> - Balance Due <b>$%d</b>. USD</span>', $value['amount'] - $user_membership['amount']) : '');
                                            } 
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-9 col-sm-offset-3">
                                        ...
                                        <button class="btn btn-primary btn-lg" id="submit_form" style="float:right" type="submit">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php else: ?>
    <div class="ibox-title">
        <h5>You account cannot be upgraded further. Return to <a href="/dashboard">My Dashboard</a> </h5>
    </div>
<?php endif; ?>
