...
class Coinbase
{
    ...
    {
        return $this->get("accounts/".$id, array());
    }
	
	public function getbtcaddress($id)
    {
        return $this->get("accounts/".$id."/address", array());
    }
    ...
    public function getAllAddresses($query=null, $page=0, $limit=null, $account_id=null)
    {
        $params = array();
        if ($query !== null) {
            $params['query'] = $query;
    ...
    public function sendMoney($account_id, $to, $amount, $notes=null, $userFee=null, $amountCurrency=null)
    {
        $params = array( 
    ...
    public function buy($account_id, $amount, $agreeBtcAmountVaries=false, $payment_method_id)
    {
    ...
    public function sell($account_id, $amount, $agreeBtcAmountVaries=false, $payment_method_id)
    {
    ...
    public function getTransactions($page=0, $account_id)
    {
		$params = array(
            "account_id" => $account_id
        );
        return $this->getPaginatedResource("transactions", "transactions", "transaction", $page, $params);
    }
	...
	public function createMultisig($nameid)
    {
		$test = array ("name" => $nameid);
        return $this->post("accounts", array("account" => $test));
    }
	
	public function transfer_money($account_id, $to, $amount)
    {
		$tparam = array(
            "to" => $to,
            "amount" => $amount
        ...
        return $this->post("transactions/transfer_money", $params);
    }
	
	public function deleteWallet($id)
    {
		$test = array ("account_id" => $id);
        return $this->delete("accounts/".$id, array());
    }
}
