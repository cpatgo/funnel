...
<script src="js2/jtip.js" type="text/javascript"></script>
	...
	<?php if($next_board_username[0] != '')
	{ ?>
		<form action="index.php?page=my_board_2x2" method="post">
		<input type="hidden" name="id" value="<?php echo $next_board_username[1]; ?>"	 />
		<input type="submit" name="submit" value="" style="background:url(images/o.png) no-repeat; height:48px; width:60px; border:none;" />
		</form>
		<?php print $next_board_username[0]; ?><br /><?php
	}
	else
	{ ?>
...
<?php	} ?>	
	...
	</a><?php if($pos[1] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[1]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	...
	</a><?php if($pos[2] != '0') { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[2]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[3] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[3]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[4] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[4]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[5] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[5]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[6] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[6]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	<?php if($pos[7] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[7]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[8] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[8]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[9] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[9]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[10] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[10]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[11] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[11]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[12] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[12]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[13] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[13]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[14] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[14]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
	...
	</a><?php if($pos[15] != '0' ) { ?> <a href="<?php echo $page; ?>&id=<?php echo $pos[15]; ?>"> <?php } ?><span class="dashboard_button_heading"><center>
	<div style="background:#E2FAAB; width:90px; height:60px; border:solid 1px #006600;">
	<?php 
