...
<!-- If User's membership is not Professional, allow for upgrade -->
<?php if((int)$user_membership['id'] !== 4): ?>
	...
	<div style="background-color:#fff;">
		<div class="container-fluid">
				<form class="form-horizontal" id="upgrade_form" accept-charset="utf-8">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
				                		...
				                		foreach ($membership as $key => $value) {
					                		if($value['membership'] === 'Free' || $value['membership'] === 'Founder' || $value['membership'] === 'Masters' || $user_membership['initial'] >= $value['id']) continue;
					                		printf('<div class="radio i-checks"><label><input type="radio" class="form-control" value="%d" name="upgrade_membership" %s> <i></i> %s </label></div>', 
					                			$value['id'], 
