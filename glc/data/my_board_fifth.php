...
//GET CURRENT STAGE
$query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM board_fifth WHERE board_id = '$board_break_id' ");
...
display($poss,$page,$img,$user_name,$parent_u_name,$name,$position,$date,$gender,$real_parent_u,$real_child,$bb_level,$real_info_time,$comming_board_username,$real_parent_u[1],$brdimg);
