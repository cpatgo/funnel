...
$(document).ready(function(){
	...
	form.submit(function(){
		if(validateName() & validateEmail() & validateLname() & validateCity() & validateCountry() & validatePass1() & validatePhone() & validateProvience() & validateMessage() & validateDate() & validateUsername() )
			return true
		else
			return false;   
	});
	...
	function validateEmail(){
		...
		//if it's NOT valid
			...
			emailInfo.text("Please Type a valid e-mail please");
	...
	function validateAlerts(){
		...
		//if it's NOT valid
			...
			alertsInfo.text("Please Type a valid e-mail please");
	...
	function validateName(){
		...
		if(name.val().length < 4){
			name.addClass("error");
			nameInfo.text("Please Enter more than 3 letters!");
	...
	function validateLname(){
		...
		if(l_name.val().length < 4){
			...
			l_nameInfo.text("Please Enter more than 3 letters!");
	...
	function validateCountry(){
		...
		//if it's valid
			...
			countryInfo.text("What's your Country?");
	...
	function validatePhone(){
		...
		if(phone.val().length < 5){
			...
			phoneInfo.text("Please Enter Your phone No!");
		...
		//if it's valid
			...
			phoneInfo.text("What's your phone No.?");
		...
		//if it's valid
			...
			usernameInfo.text("What's your Date Of username?");
	...
	function validateMessage(){
		...
		if(message.val().length < 10){
			...
			messageInfo.text("Please Enter Your Adderss!");
		...
		//it's valid
			...
			messageInfo.text("At least 10 charactors must be enter!");
