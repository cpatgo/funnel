...
$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from reg_voucher where mode = 1 ");
...
<div class="ibox-content">
	...
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "select * from reg_voucher where mode = 1 LIMIT $start,$plimit ");   	 	 	
...
<?php
	...
	{ ?>
		<li id="DataTables_Table_0_previous" class="paginate_button previous">
			<a href="<?="index.php?page=active_vouchers&p=".($newp-1);?>">Previous</a>
		</li>
	<?php 
	}
	for ($i=1; $i<=$pnums; $i++) 
	{ 
		...
		{ ?>
			<li class="paginate_button ">
				<a href="<?="index.php?page=active_vouchers&p=$i";?>"><?php print_r("$i");?></a>
			</li>
			<?php 
		}
		else
	...
	{ ?>
	   <li id="DataTables_Table_0_next" class="paginate_button next">
			<a href="<?="index.php?page=active_vouchers&p=".($newp+1);?>">Next</a>
	   </li>
	<?php 
	} 
	?>
