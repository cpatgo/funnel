...
<style type="text/css"> 
 ...
 .imgBox_n { background: url(images/<?php echo $path; ?>/oak2.png) no-repeat;  height:82px;width:80px; }
 .imgBox_n:hover {  background: url(images/<?php echo $path; ?>/oak_nhover.png) no-repeat;width:80px; height:82px;  }
 
 .imgBox_n1 { background: url(images/<?php echo $path; ?>/oak2.png) no-repeat;  height:82px;width:82px; }
 .imgBox_n1:hover {  background: url(images/<?php echo $path; ?>/oak_nhover.png) no-repeat; height:82px;width:80px; }
 
 .imgBox_n2 { background: url(images/<?php echo $path; ?>/oak2nn.png) no-repeat;  height:62px;width:60px; }
 .imgBox_n2:hover {  background: url(images/<?php echo $path; ?>/oak_nhovernn.png) no-repeat; height:62px;width:60px; }
 .imgBox_n_top{ background: url(images/<?php echo $path; ?>/oak_top.png) no-repeat; height:64px;width:130px; line-height:22px; 
 }
 .imgBox_n_top:hover{ background: url(images/<?php echo $path; ?>/oak_top_hover.png) no-repeat; height:64px;width:130px; line-height:22px;
 }
 
 .imgBox_n_bottom{ background: url(images/<?php echo $path; ?>/oak_bottom.png) no-repeat; height:39px;width:80px; line-height:22px; 
 }
 .imgBox_n_bottom:hover{ background: url(images/<?php echo $path; ?>/oak_bottom_hover.png) no-repeat; height:39px;width:80px; line-height:22px;
 }
...
-->
	...
	<div style="padding-top:65px; display:block;font-size:20px;">
	<a  href="binary_tree/user1.php?name=<?php print $name[1]; ?>&username=<?php print $user_name[1]; ?>&child=<?php print $child[1]; ?>&date=<?php print $date[1]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[1]; ?>&sponser_name=<?php echo $real_parent[1]; ?>&id=<?php echo $pos[1]; ?>" class="jTip" id="two" name="<?php print $name[1]; ?>" style="text-decoration:none;">&nbsp;
	<?php 
		print $user_name[1];
		if($all_child[1][0] != '')
		{
	...
	<td colspan="4" align="center">	
		...
		<div style="padding-top:50px;font-size:20px; display:block;"> 
		<a style="margin-left:0px;" href="binary_tree/user2.php?name=<?php print $name[2]; ?>&username=<?php print "".$user_name[2]; ?>&child=<?php print $child[2]; ?>&date=<?php print $date[2]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[2]; ?>&sponser_name=<?php print $real_parent[2]; ?>" class="jTip" id="three" name="<?php print $name[2]; ?>" style="text-decoration:none;"> 
		<?php 
			print $user_name[2];
			if($all_child[2][0] != '')
			{
	...
	<td colspan="4" align="center">
		...
		<div style="padding-top:50px;font-size:20px; display:block;">
		<a style="margin-left:0px;" href="binary_tree/user3.php?name=<?php print $name[3]; ?>&username=<?php print "".$user_name[3]; ?>&child=<?php print $child[3]; ?>&date=<?php print $date[3]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[3]; ?>&sponser_name=<?php echo $real_parent[3]; ?>" class="jTip" id="four" name="<?php print $name[3]; ?>" style="text-decoration:none;">
		<?php 
			print "".$user_name[3]."
			<br>"."";
			if($all_child[3][0] != '')
	...
	<td colspan="2" align="center">
		<div style="padding-top:50px;font-size:20px; display:block;">
			<a href="binary_tree/user4.php?name=<?php print $name[4]; ?>&username=<?php print "".$user_name[4]; ?>&child=<?php print $child[4]; ?>&date=<?php print $date[4]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[4]; ?>&sponser_name=<?php echo $real_parent[4]; ?>" class="jTip" id="five" name="<?php print $name[4]; ?>" style="text-decoration:none;">
			<?php 
				print "".$user_name[4]."
	...
	<td colspan="2" align="center">
		<div style="padding-top:50px;font-size:20px; display:block;">
		<a href="binary_tree/user5.php?name=<?php print $name[5]; ?>&username=<?php print "".$user_name[5]; ?>&child=<?php print $child[5]; ?>&date=<?php print $date[5]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[5]; ?>&sponser_name=<?php echo $real_parent[5]; ?>" class="jTip" id="six" name="<?php print $name[5]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[5]."
		<br>"."";
		if($all_child[5][0] != '')
	...
	<td colspan="2" align="center">
		<div style="padding-top:50px;font-size:20px; display:block;">
			<a href="binary_tree/user6.php?name=<?php print $name[6]; ?>&username=<?php print "".$user_name[6]; ?>&child=<?php print $child[6]; ?>&date=<?php print $date[6]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[6]; ?>&sponser_name=<?php echo $real_parent[6]; ?>" class="jTip" id="server" name="<?php print $name[6]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[6]."
	...
	<td colspan="2" align="center">
		...
		<div style="padding-top:50px;font-size:20px; display:block;">
		<a href="binary_tree/user7.php?name=<?php print $name[7]; ?>&username=<?php print "".$user_name[7]; ?>&child=<?php print $child[7]; ?>&date=<?php print $date[7]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[7]; ?>&sponser_name=<?php echo $real_parent[7]; ?>" class="jTip" id="eight" name="<?php print $name[7]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[7]."
	...
	<!--<tr>
	<th colspan=2><img src="function/binary_layout/arrow3.png" /></th>
	<th colspan=2><img src="function/binary_layout/arrow3.png"/></th>
	<th colspan=2><img src="function/binary_layout/arrow3.png"/></th>
	<th colspan=2><img src="function/binary_layout/arrow3.png" /></th>
	</tr>
	...
	<div class="imgBox_n2" style="display:block;">
		<div style="padding-top:40px;font-size:10px; display:block;">
			<a href="binary_tree/user8.php?name=<?php print $name[8]; ?>&username=<?php print "".$user_name[8]; ?>&child=<?php print $child[8]; ?>&date=<?php print $date[8]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[8]; ?>&sponser_name=<?php echo $real_parent[8]; ?>" class="jTip" id="nine" name="<?php print $name[8]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[8]."
	...
	<div class="imgBox_n2" style="display:block;">
		<div style="padding-top:40px;font-size:10px; display:block;">
		<a href="binary_tree/user9.php?name=<?php print $name[9]; ?>&username=<?php print "".$user_name[9]; ?>&child=<?php print $child[9]; ?>&date=<?php print $date[9]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[9]; ?>&sponser_name=<?php echo $real_parent[9]; ?>" class="jTip" id="ten" name="<?php print $name[9]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[9]."
		<br>"."";
		if($all_child[9][0] != '')
		{
			...
			<!--<img src="images/oak2.png" height=60/>
	</th><th valign="top" align="center">
	
	<div class="imgBox_n2" style=" display:block;">
		<div style="padding-top:40px;font-size:10px; display:block;">
		<a href="binary_tree/user10.php?name=<?php print $name[10]; ?>&username=<?php print "".$user_name[10]; ?>&child=<?php print $child[10]; ?>&date=<?php print $date[10]; ?>&level=<?php print $level; ?>&gender=<?php echo $gender[10]; ?>&sponser_name=<?php echo $real_parent[10]; ?>" class="jTip" id="eleven" name="<?php print $name[10]; ?>" style="text-decoration:none;">
		<?php 
		print "".$user_name[10]."
